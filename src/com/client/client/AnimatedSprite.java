...
public final class AnimatedSprite extends Sprite {
  ...
  public AnimatedSprite(String file) { this(file, DUMMY_COMPONENT); }
  
  public final Component component;
  
  public AnimatedSprite(String file, Component component) { this(file, component, 0, 0); }
  public final int width;
  public final int height;
  
  public AnimatedSprite(File file) { this(file, DUMMY_COMPONENT); }
  public final int[] pixels;
  public final BufferedImage buffer;
  
  public AnimatedSprite(File file, Component component) { this(loadFile(file), component); }


  
  public AnimatedSprite(byte[] data) { this(data, DUMMY_COMPONENT); }


  
  public AnimatedSprite(byte[] data, Component component) { this(loadImage(data, component), component); }


  
  public AnimatedSprite(Image image) { this(image, DUMMY_COMPONENT); }


  
  public AnimatedSprite(Image image, Component component) { this(image, component, 0, 0); }


  
  public AnimatedSprite(String file, int width, int height) { this(file, DUMMY_COMPONENT, width, height); }


  
  public AnimatedSprite(String file, Component component, int width, int height) { this(new File(file), component, width, height); }


  
  public AnimatedSprite(File file, int width, int height) { this(file, DUMMY_COMPONENT, width, height); }


  
  public AnimatedSprite(File file, Component component, int width, int height) { this(loadFile(file), component, width, height); }


  
  public AnimatedSprite(byte[] data, int width, int height) { this(data, DUMMY_COMPONENT, width, height); }


  
  public AnimatedSprite(byte[] data, Component component, int width, int height) { this(loadImage(data, component), component, width, height); }


  
  public AnimatedSprite(Image image, int width, int height) { this(image, DUMMY_COMPONENT, width, height); }


  
  public AnimatedSprite(URL url) { this(url, DUMMY_COMPONENT); }


  
  public AnimatedSprite(URL url, Component component) { this(url, component, 0, 0); }


  
  public AnimatedSprite(URL url, int width, int height) { this(url, DUMMY_COMPONENT, width, height); }


  
  public AnimatedSprite(URL url, Component component, int width, int height) { this(loadImage(url, component), component, width, height); }
  ...
  public AnimatedSprite(Image image, Component component, int width, int height) {
    ...
    this.buffer = new BufferedImage(model, Raster.createWritableRaster(model.createCompatibleSampleModel(newWidth, newHeight), new DataBufferInt(pixels, pixelCount), null), false, new Hashtable());
    this.scaleDetail = 0;
  ...
  public AnimatedSprite getInstance(int width, int height) { return getInstance(width, height, false); }


  
  public AnimatedSprite getInstance(int width, int height, boolean absScale) { return new AnimatedSprite(this, width, height, absScale); }
  ...
  public void block_copy_mask(int[] src, int scanSize, byte[] dir, int height, int[] dst, int tmp, int dstOff, int dstPtr, int srcOff, int srcPtr) {
    ...
    scanSize = -(scanSize & 0x3);
    
    for (int y = -height; y != 0; y++) {
      int i; for (i = scanSizeHigh; i != 0; i++) {
        if (dir[dstPtr] == 0) {
  ...
  public void setScaleDetailDefault() { this.scaleDetail = 0; }


  
  public void setScaleDetailQuality() { this.scaleDetail = 1; }


  
  public void setScaleDetailSpeed() { this.scaleDetail = 2; }
  ...
  public boolean isScaleDetailQuality() { return (this.scaleDetail == 1); }


  
  public boolean isScaleDetailSpeed() { return (this.scaleDetail == 2); }


  
  public int getScaleDetail() { return this.scaleDetail; }


  
  public void setAutoUpdate(boolean autoUpdate) { autoUpdate = this.autoUpdate; }
  ...
  public boolean isValid() { return (this.realWidth > 0 && this.realHeight > 0); }
