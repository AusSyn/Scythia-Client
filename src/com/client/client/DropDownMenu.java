...
public class DropDownMenu extends RSInterface {
    ...
    public DropDownMenu(int identifier, int width, int backgroundColor, int hoverColor, int columnAmount, int columnWidth,
        ...
        disabledSprite = GameClient.cacheSprite[ARRROW_UP];
        enabledSprite = GameClient.cacheSprite[ARRROW_DOWN];
    }
    ...
    public boolean drawInterface(final GameClient client, int widgetDrawX, int widgetDrawY, int subWidgetDrawX,
         ...
         */
        client.newSmallFont.drawCenteredString(message, drawX + (width - 16) / 2, drawY + 13, 0xFF981F, -1);
        ...
        if (isOpen()) {
            ...
            if (GameClient.openInterfaceID == 28630 && id >= 28670 && id <= 28683) { //Hot keys
                final int tabStoneSprite = (id - 28670) + (id - 28);
                RSInterface.interfaceCache[tabStoneSprite].disabledSprite = GameClient.cacheSprite[12];
            }
            ...
            for (DropDownAction action : getActions()) {
                ...
                client.newSmallFont.drawCenteredString(action.getMessage(), drawX + columnWidth / 2, drawY + 16 - 2, 0xFF981F, -1);
    ...
    public void setOpen(boolean isOpen) {
        ...
        GameClient.dropdownOpen = isOpen;
    }
