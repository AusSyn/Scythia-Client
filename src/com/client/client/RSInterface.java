...
import com.client.client.Interfaces.AchievementInterface;
import com.client.client.Interfaces.PlayerPanelNew;
import com.client.client.Interfaces.CollectionLog;
...
public class RSInterface {
    ...
    public boolean drawInterface(final GameClient client, int widgetDrawX, int widgetDrawY, int subWidgetDrawX,
            int subWidgetDrawY) {
        return false;
    }
    ...
    private static void BoxRewardList(TextDrawingArea[] textDrawingAreas) {
        ...
        scrollTableft.scrollMax = 900;
        scrollTabright.width = 334;
        scrollTabright.height = 225;
        scrollTabright.scrollMax = 1200;
    ...
    private static void overloadTimer(TextDrawingArea[] tda) {
        RSInterface main = addInterface(48300);
        addSpriteLoader(48301, 1291);
        addText(48302, "000 Minutes", tda, 0, ColorConstants.SKY_BLUE, false, true);
        addText(48303, "Overload", tda, 0, ColorConstants.SNOW_WHITE, false, true);
    ...
    private static void damageTimer(TextDrawingArea[] tda) {
        RSInterface main = addInterface(48304);
        addSpriteLoader(48305, 1291);
        addText(48306, "000 Minutes", tda, 0, ColorConstants.SKY_BLUE, false, true);
        addText(48307, "x2 Damage", tda, 0, ColorConstants.SNOW_WHITE, false, true);
        main.totalChildren(3);
        main.child(0, 48305, 35 + 100 - 8 + 330 + 5, 275 + 8 + 5 - 250);
        main.child(1, 48306, 11 + 102 + 330 + 5, 305 + 5 + 5 - 250);
        main.child(2, 48307, 11 + 106 + 330 + 5, 305 - 5 + 5 - 250);
    }
    ...
    public static void achievements(TextDrawingArea[] tda) {
        ...
        addConfigButtonWSpriteLoader(id, 41750, 1025, 1025, 119, 21, "Easy", 0, 5, 1090);
        tab.child(c++, id++, 8 + x, 22 + y);
        addConfigButtonWSpriteLoader(id, 41750, 1025, 1025, 119, 19, "Medium", 1, 5, 1090);
        tab.child(c++, id++, 124 + x, 22 + y);
        addConfigButtonWSpriteLoader(id, 41750, 1025, 1025, 119, 19, "Hard", 2, 5, 1090);
        tab.child(c++, id++, 242 + x, 22 + y);
        addConfigButtonWSpriteLoader(id, 41750, 1025, 1025, 119, 19, "Elite", 3, 5, 1090);
    ...
    private static void starterProgression() {
        ...
        addTransparentSpriteWSpriteLoader(STARTING_POINT + 1, 1287, 75);
        //addSpriteLoader(STARTING_POINT + 1, 1230);
        main.child(0, STARTING_POINT + 1, 120, 275);
        addTextComponent(STARTING_POINT + 2, "Next Rewards", fonts, 1, ColorConstants.ORANGE, true, false, 1, 1);
        main.child(1, STARTING_POINT + 2, 341, 278);
        addTextComponent(STARTING_POINT + 3, "NpcName", fonts, 2, ColorConstants.ORANGE, true, true, 1, 1);
        ...
        addProgressBar(STARTING_POINT + 5, 155, 25, 35, 0xFF0000, 0x276b23);
    ...
    public static void killcounterInterface() {
        RSInterface tab = addTabInterface(41700);
        addTransparentSpriteWSpriteLoader(41701, 1286, 150);
        addText(41703, " Kill count  ", fonts, 2, 0x66FFFF, true, true);
        addText(41706, " Training ", fonts, 2, 16750623, true, true);
        addText(41704, "0", fonts, 2, 16777215, true, true);
        tab.totalChildren(4);
        tab.child(0, 41701, 373, 195);
        tab.child(1, 41702, 454, 196);
        tab.child(2, 41703, 449, 206);
        tab.child(3, 41704, 389, 206);
    }
    ...
    private static void groupIronman(TextDrawingArea[] tda) {
		...
		RSInterface main = addInterface(STARTING_POINT);
		addSpriteLoader(STARTING_POINT + 1, 1329); // 1119
		...
		addHoverableSprite(STARTING_POINT + 127, 1330, 1331, true, "Manage group");
		...
		int spriteY = 78;
		for (int i = 0; i < 4; i++) {
			addSpriteLoader(STARTING_POINT + 17 + i, i % 2 == 0 ? 1332 : 1333);
		...
		for (int i = 0; i < 6; i++) {
			addSpriteLoader(STARTING_POINT + 101 + i, i % 2 == 0 ? 1334 : 1335);
		...
		int logSprite = 1;
		for (int i = 0; i < 50; i++) {
			addSpriteLoader(STARTING_POINT + 131 + i, i % 2 == 0 ? 1336 : 1337);
		...
		addSpriteLoader(manageStart + 1, 1338);
        manageInterface.totalChildren(10);
        manageInterface.child(0, manageStart + 1, 0, 0);

        addHoverableSprite(manageStart + 2, 1339, 1340, true, "Create group");
        manageInterface.child(1, manageStart + 2, 11, 7);
        addHoverableSprite(manageStart + 3, 1339, 1340, true, "Invite player");
        manageInterface.child(2, manageStart + 3, 11, 40);
        addHoverableSprite(manageStart + 4, 1339, 1340, true, "Kick player");
        manageInterface.child(3, manageStart + 4, 11, 73);
        addHoverableSprite(manageStart + 5, 1339, 1340, true, "Delete group");
        manageInterface.child(4, manageStart + 5, 11, 106);
        addTextComponent(manageStart + 6, "Create group", fonts, 2, 10040064, false, true, 0, 0);
        manageInterface.child(5, manageStart + 6, 17, 12);
        addTextComponent(manageStart + 7, "Invite player", fonts, 2, 10040064, false, true, 0, 0);
        manageInterface.child(6, manageStart + 7, 17, 45);
        addTextComponent(manageStart + 8, "Kick player", fonts, 2, 10040064, false, true, 0, 0);
        manageInterface.child(7, manageStart + 8, 24, 80);
        addTextComponent(manageStart + 9, "Delete group", fonts, 2, 10040064, false, true, 0, 0);
        manageInterface.child(8, manageStart + 9, 17, 113);

        addCloseButton(manageStart + 10);
        manageInterface.child(9, manageStart + 10, 329, 5);
	...
	private static void groupIronmanBank() {
        ...
        addSpriteLoader(STARTING_POINT + 1, 1341);
		...
		addToggleButton1(STARTING_POINT + 7, 1342, 1343, 25, 25, "Withdraw As Note");
        main.child(4, STARTING_POINT + 7, 94, 95);
    }

	private static void groupIronmanLeaderboard() {
        final int STARTING_POINT = 60900;
        
        RSInterface main = addInterface(STARTING_POINT);

        addSpriteLoader(STARTING_POINT + 1, 1344);
        main.totalChildren(15);
        main.child(0, STARTING_POINT + 1, 10, 10);

        addSpriteLoader(STARTING_POINT + 2, 1345);
        main.child(1, STARTING_POINT + 2, 19, 45);
        addSpriteLoader(STARTING_POINT + 3, 1346);
        ...
        int yPos = 0;
        for (int i = 0; i < 30; i++) {
            addSpriteLoader(STARTING_POINT + 31 + i, i % 2 == 0 ? 1347 : 1348);
    ...
    public static void otherTeles(TextDrawingArea[] tda) {
        RSInterface tab = addInterface(38800);
        String dir = "Sprites/interfaces/BossTeles/SPRITE";
        addSpriteLoader(38801, 1081);
        addHoverSpriteLoaderButton(38802, 737, 16, 16, "Close", -1, 38803, 1);
        addHoveredSpriteLoaderButton(38803, 16, 16, 47269, 738);
        addNpc(38804, 50);

        interfaceCache[38804].modelZoom = 2400;
        addHoverButton(38805, dir, 5, 99, 27, "Teleport", -1, 38806, 1);
        addHoveredButton(38806, dir, 6, 99, 27, 36813);
        addText(38807, "Teleport", tda, 0, 16751360, true, true);
        addText(38808, "Name here", tda, 0, 16751360, true, true);

        tab.totalChildren(10);

        tab.child(0, 38801, 5, 20);
        tab.child(1, 38802, 478, 28);
        tab.child(2, 38803, 478, 28);
        tab.child(3, 38804, 110, 30);
        tab.child(4, 38805, 370, 273);
        tab.child(5, 38806, 370, 273);
        tab.child(6, 38807, 420, 282);
        tab.child(7, 38808, 180, 154);
        tab.child(8, 38809, 346, 50);
        tab.child(9, 38829, 50, 177);

        RSInterface.interfaceCache[38800].npcDisplay = 239;

        RSInterface desc = addInterface(38809);
        desc.totalChildren(9);
        desc.width = 125;
        desc.height = 215;
        desc.scrollMax = 250;
        for (int j = 0; j < 9; j++) {
            String[] names = {"Barrows", "Fight Caves", "Fight Pits", "Pest Control", "Duel Arena", "Warrior's Guild", "Recipe For Disaster", "Nomad's Requeim", "Treasure Island"};

            addClickableText(38810 + j, names[j], "Select this teleport", fonts, 0, 16751360, 167, 13);
            desc.child(j, 38810 + j, 10, 5 + j * 15);

        }

        RSInterface Text = addInterface(38829);
        Text.totalChildren(15);
        Text.width = 260;
        Text.height = 120;
        Text.scrollMax = 250;
        for (int j = 0; j < 15; j++) {
            addText(38830 + j, "", tda, 0, 16777215, false, true);
            Text.child(j, 38830 + j, 10, 5 + j * 15);
    ...
    public static void itemInformation(TextDrawingArea[] tda) {
        RSInterface inter = addTabInterface(56000);

        addText(56002, "Title", tda, 2, 0xff981f, true, true);
        addSpriteLoader(56001, 581);

        inter.totalChildren(4);

        inter.child(0, 56001, 4, 5);
        inter.child(1, 56002, 250, 9);
        inter.child(2, 15210, 480, 6);
        inter.child(3, 56050, 0, 38);

        inter = addTabInterface(56050);
        inter.contentType = 504;
        inter.width = 478;
        inter.height = 253;
        inter.scrollMax = 200 * 30 + (200 * 12);

        for (int i = 56302; i < 56702; i++) {
        ...
        inter.child(Child, 56800, 30, 0);

        RSInterface Interface = addTabInterface(56800);
    ...
    private static void mysteryBoxViewer(TextDrawingArea[] tda) {
        ...
        addSpriteLoader(48031, 1280);
        addText(48032, "Common Rewards", tda, 0, 0xff8624, true, true);
        addText(48033, "Uncommon Rewards", tda, 0, 0xff8624, true, true);
        addText(48034, "Rare Rewards", tda, 0, 0xff8624, true, true);
        addText(48035, "Chest #:", tda, 1, 0xff8624, false, true);

        addHoverButtonWSpriteLoader(48036, 1281, 90, 25, "Open", -1, 48037, 1);
        addHoveredImageWSpriteLoader(48037, 1282, 90, 25, 48038);

        addHoverButtonWSpriteLoader(48039, 1281, 90, 25, "Open All", -1, 48040, 1);
        addHoveredImageWSpriteLoader(48040, 1282, 90, 25, 48041);

        addText(48042, "Open", tda, 0, 0xff8624, true, true);
        addText(48043, "Open All", tda, 0, 0xff8624, true, true);

        addText(48044, "Donator Chest Interface", tda, 1, ColorConstants.WHITE, true, true);
    ...
    public static void fuser(TextDrawingArea[] tda) {
        RSInterface tab = addInterface(43500);
        addSpriteLoader(43501, 1288);

        int interfaceId = 43502;

        for (int i = 0; i < 10; i++) {
            addClickableText(interfaceId, "", "", tda, 0, 0x00ff0d, false, true, 110);
            interfaceId++;
        }

        interfaceId = 43513;
        for (int k = 0; k < 20; k++) {
            addItemOnInterface(interfaceId, 43500, new String[]{null, null});
            interfaceId++;
        }
        ...
        addHoveredSpriteLoaderButton(43539, 120, 34, 43540, 1200);
        ...
        for (int i = 1; i < 11; i++) {
            tab.child(i, interfaceId, 65, 93 + x);
            interfaceId++;
            x += 15;
        }
        ...
        tab.child(31, 43534, 120, 77);
        tab.child(32, 43535, 345, 57);
        tab.child(33, 43536, 270, 28);
        tab.child(34, 43537, 257, 252);
        tab.child(35, 43538, 310, 249);
        tab.child(36, 43539, 310, 249);
        tab.child(37, 43541, 370, 258);
    }

    public static void teleportInterface(TextDrawingArea[] tda) {
        RSInterface tab = addInterface(45800);
        addSpriteLoader(45801, 1270);
        addPet(45802);
        addText(45803, "Npc List", tda, 3, 0xed9507, true, true);
        addText(45804, "Npc Preview", tda, 3, 0xed9507, true, true);
        addText(45805, "Information", tda, 3, 0xed9507, true, true);
        addText(45806, "Drops", tda, 3, 0xed9507, true, true);
        addText(45807, "Combat level:", tda, 3, 0xed9507, false, true);
        addText(45808, "Hp:", tda, 1, 0xed9507, false, true);
        addText(45809, "Maxhit:", tda, 1, 0xed9507, false, true);
        addText(45810, "Difficulty:", tda, 1, 0xed9507, false, true);
        addText(45843, "Difficulty:", tda, 1, 0xed9507, false, true);

        addText(45836, "Monsters", tda, 1, 0xed9507, true, true);
        addText(45837, "Bosses", tda, 1, 0xed9507, true, true);
        addText(45838, "Minigames", tda, 1, 0xed9507, true, true);
        addText(45839, "Multi Boss", tda, 1, 0xc90000, true, true);
        addText(45840, "Raids", tda, 1, 0xed9507, true, true);
        addText(45841, "Others", tda, 1, 0xed9507, true, true);
        addText(45842, "Teleport", tda, 1, 0xed9507, true, true);
        ...
        for (int i = 0; i < 6; i++) {
            ...
            addHoverButtonWSpriteLoader(interfaceId, 1251, 88, 24, "Add", -1, interfaceId2, 1);
            addHoveredSpriteLoaderButton(interfaceId2, 88, 24, interfaceId3, 1252);

            interfaceId += 3;
        }

        addHoverButtonWSpriteLoader(45830, 1208, 21, 21, "Add", -1, 45831, 3);
        addHoveredSpriteLoaderButton(45831, 21, 21, 45832, 1209);

        addHoverButtonWSpriteLoader(45833, 1245, 151, 29, "Add", -1, 45834, 1);
        addHoveredSpriteLoaderButton(45834, 151, 29, 45835, 1246);

        tab.totalChildren(36);

        tab.child(0, 45801, 5, 5);
        tab.child(1, 45900, 10, 76);
        tab.child(2, 45802, 150, 90);
        tab.child(3, 45803, 85, 53);
        tab.child(4, 45804, 233, 56);
        tab.child(5, 45805, 383, 56);
        tab.child(6, 45806, 210, 207);
        tab.child(7, 45807, 323, 85);
        tab.child(8, 45808, 323, 85 + 20);
        tab.child(9, 45809, 323, 85 + 20 + 20);
        tab.child(10, 45810, 323, 85 + 20 + 20 + 20);

        int tabId = 11;
        interfaceId = 45811;
        int x = 0;
        for (int i = 0; i < 6; i++) {
            tab.child(tabId, interfaceId, 15 + x, 12);
            tabId++;
            interfaceId++;
            tab.child(tabId, interfaceId, 15 + x, 12);
            interfaceId += 2;
        ...
        tab.child(23, 45830, 480, 12);
        tab.child(24, 45831, 480, 12);
        tab.child(25, 45833, 348, 203);
        tab.child(26, 45834, 348, 203);
        ...
        for (int i = 0; i < 6; i++) {
            ...
            tab.child(tabId, interfaceId, 50 + x, 14);
            tabId++;
            interfaceId++;
            x += 80;
            x = (x - (2 * i));
        }
        tab.child(33, 45842, 424, 208);
        tab.child(34, 45843, 323, 85 + 20 + 20 + 20 + 20);
        tab.child(35, 45700, 141, 232);

        RSInterface items = addInterface(45700);
        items.scrollMax = 1000;
        items.height = 89;
        items.width = 342;
        ...
        for (int j = 0; j < 60; j++) {
            addClickableText(45901 + j, "", "", tda, 0, 0x00ff0d, false, true, 110);
        }
    ...
    public static void upgradeInterface(TextDrawingArea[] tda) {
        ...
        tab.addText(62250, "Upgrade Chance:", fonts, 2, 0x32CD32);
        ...
        addButtonWSpriteLoader(62230, 1285, "@red@Close Interface");
    ...
    public static void bossTeles(TextDrawingArea[] tda) {
        ...
        String dir = "Sprites/interfaces/BossTeles/SPRITE";
        addSpriteLoader(36801, 1078);

        addHoverSpriteLoaderButton(36802, 737, 16, 16, "Close", -1, 36803, 1);
        addHoveredSpriteLoaderButton(36803, 16, 16, 47269, 738);

        addText(36805, "Boss Teleports", tda, 2, 16753920, true, true);
        addText(36806, "Bosses", tda, 2, 16753920, true, true);
        addText(36807, "Possible drops and rewards:", tda, 0, 16753920, false, true);
        addText(36808, "", tda, 1, 16753920, true, true);
        addText(36809, "Information:", tda, 1, 16753920, false, true);
        addPet(36810);
        ...
        addText(36814, "Teleport", tda, 1, 16748608, true, true);
        int x = 5;
        int y = 5;
        ...
        for (int i = 0; i < 5; i++) {
            addText(36926 + i, "", tda, 0, 16777215, false, true);
            desc.child(i, 36926 + i, 3, 4 + i * 14);
        }
        for (int i = 0; i < 8; i++) {
            addText(36931 + i, i == 0 ? "Notable Drops:" : "", tda, 0, i == 0 ? 16753920 : 16748608, false, true);
        ...
        int child = 0;
        int x1 = 5;
        for (int i = 39921; i < 39927; i++) {
            addItemOnInterface(i, 59000, new String[]{});
            items.child(child, i, x1, 5);
            child++;
            x1 += 54;
        }
        /**
        ...
        child = 6;
        x1 = 5;
        for (int i = 39927; i < 39935; i++) {
            addItemOnInterface(i, 59000, new String[]{});
            items.child(child, i, x1, 40);
            child++;
            x1 += 54;
        }
        /**
        ...
        child = 13;
        x1 = 5;
        for (int i = 39935; i < 39943; i++) {
            addItemOnInterface(i, 59000, new String[]{});
            items.child(child, i, x1, 75);
            child++;
            x1 += 54;
        }


        RSInterface.interfaceCache[36800].npcDisplay = 2026;

        RSInterface bosses = addInterface(36830);
        int yy = 0;
        bosses.totalChildren(72);
        for (int i = 0; i < 24; i++) {
            String[] names = {"King Black Dragon", "Godwars", "Kalphite Queen", "Slash Bash", "Frost Dragons", "Dagannoth Kings", "Tormented Demons", "Barrelchests", "Chaos Elemental", "Lizardman Shaman", "Bork", "Corporeal Beast", "Phoenix", "Bandos avatar", "Glacors", "Nex", "Scorpia", "Venenatis", "Cerbertus", "Skotizo", "Abyssal Sire", "Giant Mole", "Kraken", "Zulrah"};
            addHoverButton(36831 + i, dir, 3, 115, 19, "View", -1, 36860 + i, 1);
            addHoveredButton(36860 + i, dir, 4, 115, 19, 36829);

            addText(36890 + i, names[i], tda, 0, 16748608, true, true);

            bosses.child(i, 36831 + i, 0, yy);
            bosses.child(i + 24, 36860 + i, 0, yy);
            bosses.child(i + 48, 36890 + i, 54, yy + 4);
            yy += 19;
        }
        bosses.width = 105;
        bosses.height = 256;
    ...
    private static void dropTableCheckerInterface(TextDrawingArea[] rsFont) {
        ...
        int xPosition = 174;
        addText(37908, "@whi@100%", 0xFFFFFF, true, true, -1, 1);
        setBounds(37908, xPosition + 13, 55, 14, main_widget);
        xPosition += 39;

        addText(37909, "@whi@25%", 0xFFFFFF, true, true, -1, 1);
        setBounds(37909, xPosition + 13, 55, 15, main_widget);
        xPosition += 39;

        addText(37910, "@whi@15%", 0xFFFFFF, true, true, -1, 1);
        setBounds(37910, xPosition + 14, 55, 16, main_widget);
        xPosition += 39;

        addText(37911, "@whi@5.0%", 0xFFFFFF, true, true, -1, 1);
        setBounds(37911, xPosition + 14, 55, 17, main_widget);
        xPosition += 39;

        addText(37912, "@whi@2.0%", 0xFFFFFF, true, true, -1, 1);
        setBounds(37912, xPosition + 13, 55, 18, main_widget);
        xPosition += 39;

        addText(37913, "@whi@0.5%", 0xFFFFFF, true, true, -1, 1);
        setBounds(37913, xPosition + 12, 55, 19, main_widget);
        xPosition += 39;

        addText(37914, "@whi@0.2%", 0xFFFFFF, true, true, -1, 1);
        setBounds(37914, xPosition + 12, 55, 20, main_widget);
        xPosition += 39;

        addText(37926, "@whi@0.1%", 0xFFFFFF, true, true, -1, 1);
    ...
    public static void playerOwnedShopInterface2(TextDrawingArea[] tda) {
        ...
        addHoverSpriteLoaderButton(33607, 737, 16, 16, "Close", -1,
                32608, 1);
...
public static final int WRAPPED_TEXT = 20; //type
    ...
    public static void newStarter(TextDrawingArea[] tda) {
        ...
        addConfigButtonWSpriteLoader(52756, 51750, 1370, 1371, 150, 25, "Select Normal", 0, 5, 1085);
        addConfigButtonWSpriteLoader(52757, 51750, 1370, 1371, 150, 25, "Select Ironman", 1, 5, 1085);
        addConfigButtonWSpriteLoader(52758, 51750, 1370, 1371, 150, 25, "Select Ultimate Ironman", 2, 5, 1085);
        addConfigButtonWSpriteLoader(52773, 51750, 1370, 1371, 150, 25, "Select Group Ironman", 3, 5, 1085);
        addConfigButtonWSpriteLoader(52776, 51750, 1370, 1371, 150, 25, "Select Veteran (Extreme Mode)", 4, 5, 1085);
        addSpriteLoader(52759, 712);
        addSpriteLoader(52760, 711);
        addSpriteLoader(52777, 716);
        addSpriteLoader(52775, 1372);
        ...
        addText(52766, "", ColorConstants.ORANGE, true, true, 52,
                tda, 0);
        addText(52767, "", ColorConstants.ORANGE, true, true, 52,
                tda, 0);
        addText(52768, "", ColorConstants.ORANGE, true, true, 52, tda, 0);
        addHoverButtonWSpriteLoader(52769, 1373, 118, 28, "Confirm selection", -1, 52770, 1);
        addHoveredImageWSpriteLoader(52770, 1374, 118, 28, 52771);
        
        addText(52772, "Confirm", ColorConstants.ORANGE, true, true, 52, tda, 2);
        addText(52798, "", ColorConstants.ORANGE, true, true, 52, tda, 0);
    ...
    public RSFontSystem getFont() {
        switch (fontType) {
            case 0:
                return GameClient.instance.newSmallFont;
            case 1:
                return GameClient.instance.newRegularFont;
            case 2:
                return GameClient.instance.newBoldFont;
            case 3:
                return GameClient.instance.newFancyFont;
        }
        return GameClient.instance.newSmallFont;
    }
    ...
    public static void unpack(CacheArchive streamLoader,
        ...
        otherTeles(textDrawingAreas);
        killcounterInterface();
        ...
        AchievementsNew();
        AchievementInterface.unpack(textDrawingAreas);
        PlayerPanelNew.playerPanelInterface(textDrawingAreas);
        overloadTimer(textDrawingAreas);
        damageTimer(textDrawingAreas);
        ...
        gambleInterfaces(textDrawingAreas);
        ExpRewardInterface();
        slayerBuyInterface();
        barrowsInterface();
        TeleTAB1();
        ...
        bestInSlot();
		balloonDropParty();
		dropInterface(textDrawingAreas);
        customTasksInterface();
	...
	public static void dropInterface(TextDrawingArea[] tda) {
		final int STARTING_POINT = 22220;
		RSInterface main = addInterface(STARTING_POINT);
		addSpriteLoader(STARTING_POINT + 1, 1314);
		addHoverButtonWSpriteLoader(STARTING_POINT + 2, 1325, 159, 29, "Search NPC", -1, STARTING_POINT + 3, 1);
		addHoveredImageWSpriteLoader(STARTING_POINT + 3, 1326, 159, 29, STARTING_POINT + 4);
		addText(STARTING_POINT + 5, "Search NPC", tda, 1, ColorConstants.RS_ORANGE, false, true);
		addText(STARTING_POINT + 6, "NPC's", tda, 2, ColorConstants.RS_ORANGE, false, true);
		addText(STARTING_POINT + 7, "Drop Table", tda, 2, ColorConstants.RS_ORANGE, true, true);
		addCloseButtonSmall(STARTING_POINT + 8, STARTING_POINT + 9, STARTING_POINT + 10);
		main.totalChildren(10);
		main.child(0, STARTING_POINT + 1, 12, 11);
		main.child(1, STARTING_POINT + 2, 20, 279);
		main.child(2, STARTING_POINT + 3, 20, 279);
		main.child(3, STARTING_POINT + 5, 79, 286);
		main.child(4, STARTING_POINT + 6, 77, 52);
		main.child(5, STARTING_POINT + 7, 262, 21);
		main.child(6, STARTING_POINT + 8, 473, 21);
		main.child(7, STARTING_POINT + 9, 473, 21);
		main.child(8, STARTING_POINT + 30, 0, 70);
		main.child(9, STARTING_POINT + 360, 176, 48);
		RSInterface npcScroll = addInterface(STARTING_POINT + 30);
		npcScroll.totalChildren(300);
		npcScroll.width = 161;
		npcScroll.height = 205;
		npcScroll.scrollMax = 3305;

		int spriteY = 0;
		for (int i = 0; i < 150; i++) {
			addSpriteLoader(STARTING_POINT + 31 + i, i % 2 != 0 ? 1327 : 1328);
			npcScroll.child(i, STARTING_POINT + 31 + i, 21, spriteY);
			spriteY += 22;
		}
		int textY = 6;
		for (int i = 0; i < 150; i++) {
			addHoverableText(STARTING_POINT + 200 + i, "", "Select", tda, 0, false, true, 110, ColorConstants.RS_ORANGE, ColorConstants.WHITE);
			npcScroll.child(150 + i, STARTING_POINT + 200 + i, 25, textY);
			textY += 22;
		}

		RSInterface dropScroll = addInterface(STARTING_POINT + 360);
		dropScroll.width = 298;
		dropScroll.height = 260;
		dropScroll.scrollMax = 3900;
		dropScroll.totalChildren(401);
		int dropSpriteY = 2;
		for (int i = 0; i < 100; i++) {
			addSpriteLoader(STARTING_POINT + 361 + i, 1315);
			dropScroll.child(i, STARTING_POINT + 361 + i, 9, dropSpriteY);
			dropSpriteY += 39;
		}
		int amountY = 16;
		for (int i = 0; i < 100; i++) {
			addText(STARTING_POINT + 462 + i, "", tda, 0, ColorConstants.WHITE, false, true);
			dropScroll.child(100 + i, STARTING_POINT + 462 + i, 174, amountY);
			amountY += 39;
		}

		int chanceY = 16;
		for (int i = 0; i < 100; i++) {
			addText(STARTING_POINT + 563 + i, "", tda, 0, ColorConstants.WHITE, true, true);
			dropScroll.child(200 + i, STARTING_POINT + 563 + i, 255, chanceY);
			chanceY += 39;
		}

		int nameY = 16;
		for (int i = 0; i < 100; i++) {
			addText(STARTING_POINT + 664 + i, "", tda, 0, ColorConstants.WHITE, false, true);
			dropScroll.child(300 + i, STARTING_POINT + 664 + i, 52, nameY);
			nameY += 39;
		}

		addToItemGroup(STARTING_POINT + 765, 1, 150, 1, 7, true, new String[]{null, null, null, null, null});
		dropScroll.child(400, STARTING_POINT + 765, 12, 5);


	}


	private static void balloonDropParty() {
		final int STARTING_POINT = 37500;
		RSInterface main = addInterface(STARTING_POINT);
		addSpriteLoader(STARTING_POINT + 1, 1311);
		main.totalChildren(6);
		main.child(0, STARTING_POINT + 1, 10, 10);

		addTextComponent(STARTING_POINT + 2, "Balloon drop party thing", fonts, 2, 16777215, true, true, 0, 0);
		main.child(1, STARTING_POINT + 2, 254, 20);
		addHoverableSprite(STARTING_POINT + 3, 1312, 1313, true, "Accept");
    ...
    public static void addToggleButton2(int id, int[] same, int sprite, int onSprite, String tooltip, boolean on) {
        ...
        tab.atActionType = 1;
        tab.contentType = 0;
        tab.sprite1 = GameClient.cacheSprite[sprite];
        tab.sprite2 = GameClient.cacheSprite[onSprite];
...
//
    ...
    private static void AchievementsNew() {

        RSInterface tab = addTabInterface(27600);
        RSInterface scroll = addTabInterface(27700);
        addSpriteLoader(28024, 1058);
        addSpriteLoader(28025, 1061);
        addSpriteLoader(28026, 1061);

        addText(45001, "Achievements", fonts, 2, 16750623, false, true);


        tab.totalChildren(5);
        tab.child(0, 28024, 2, 65);
        tab.child(1, 28025, 5, 11);
        tab.child(2, 28026, 5, 37);

        tab.child(3, 27700, -6, 67);
        tab.child(4, 45001, 18, 14);
        ...
        for (int i = 45005; i < 45116; i++) {
            ...
            if (i == 45035 || i == 45068 || i == 45102 || i >= 45112) {
                ...
                addClickableText(i, "", "Select", fonts, 1, 0xFF8900, 167, 13);
            }
        }
        addText(45777, "Easy Tasks", fonts, 2, 0xFF9900, false, true);
        scroll.child(k, 45777, 12, 6);
        addText(45036, "Medium Tasks", fonts, 2, 0xFF9900, false, true);
        addText(45069, "Hard Tasks", fonts, 2, 0xFF9900, false, true);
        addText(45103, "Elite Tasks", fonts, 2, 0xFF9900, false, true);
        addText(45113, "Pking Tasks", fonts, 2, 0xFF9900, false, true);
    ...
    private static void questTabInterfaceNew() {
        ...
        addHoverButtonWSpriteLoader(28000, 1059, 85, 20, "View", -1, 28001, 1);
        addHoveredImageWSpriteLoader(28001, 1060, 85, 20, 28002);
        addText(28003, "          Vote", fonts, 1, 16756736, false, true);
        addHoverButtonWSpriteLoader(28004, 1059, 85, 20, "View", -1, 28005, 1);
        addHoveredImageWSpriteLoader(28005, 1060, 85, 20, 28006);
        addText(28007, "Donate", fonts, 1, 16756736, true, true);
        addHoverButtonWSpriteLoader(28008, 1061, 85, 20, "View", -1, 28009, 1);
        addHoveredImageWSpriteLoader(28009, 1061, 85, 20, 28010);
        addText(28011, "Players Online: 100", fonts, 1, 16756736, true, true);


        tab.totalChildren(11);
        tab.child(0, 28024, 2, 65);
        tab.child(1, 26700, -6, 67);
        tab.child(2, 28008, 5, 37);
        tab.child(3, 28009, 5, 37);
        tab.child(4, 28000, 5, 9);
        tab.child(5, 28001, 5, 9);
        tab.child(6, 28003, 8, 11);
        tab.child(7, 28004, 98, 9);
        tab.child(8, 28005, 98, 9);
        tab.child(9, 28007, 140, 11);
        tab.child(10, 28011, 95, 39);

        scroll.totalChildren(70);
        scroll.width = 174;
        scroll.height = 183;
        scroll.scrollMax = 730;
        ...
        for (int i = 26701; i < 26771; i++) {
            ...
            y += 14;
            k++;
            if (i == 26716 || i == 26717 || i == 26715 || i == 26758 || i == 26744 || i == 26745 || i == 26746 || i == 26747 || i == 26750 || i == 26751) {
    ...
    public static void statistics1(final TextDrawingArea[] tda) {
        ...
        addText(id + 7,
                "Rare item drop rate: 1:400. Ring of wealth drop rate 1:300",
    ...
    public static void goodieBag(TextDrawingArea[] tda) {
        ...
        addAdvancedSprite(interfaceId + index++, 1276); //main sprite
        ...
        for (int rowIndex = 1; rowIndex <= 5; rowIndex++) {
            for (int itemIndex = 1; itemIndex <= 5; itemIndex++) {
                hoverButton(interfaceId + index++, 1274, 1275, "Select " + (buttonIndex), 2, InterfaceConstants.WHITE_TEXT, String.valueOf(buttonIndex));
        ...
        int cancelWidth = GameClient.instance.newSmallFont.getTextWidth("Close goodie bag");
        ...
        mainInterface.child(index++, interfaceId + index, baseX, baseY);
    ...
    public static void mysteryBox(TextDrawingArea[] tda) {
        ...
        addNewHoverButton(47003, "Close", 1015, 1016);
        addNewHoverButton(47004, "Spin", 810, 811);
        addText(47005, "Spin", tda, 2, 0xFFA500, true, true);
        addSpriteLoader(47006, 1074);
        addSpriteLoader(47007, 1075);
        ...
        addSpriteLoader(47010, 1072);
        addSpriteLoader(47011, 1077);
    ...
    public static void addNewHoverButton(int id, String tooltip, int offSprite, int onSprite) {
        ...
        tab.atActionType = 1;
        tab.type = TYPE_HOVER;
        tab.sprite1 = GameClient.cacheSprite[offSprite];
        tab.sprite2 = GameClient.cacheSprite[onSprite];
        tab.width = tab.sprite1.myWidth;
        tab.height = tab.sprite1.myHeight;
        tab.toggled = false;
    ...
    public static void warriorGuild(TextDrawingArea[] tda) {
        ...
        addText(54502, "Defenderz", 0xff9933, true, true, -1, tda, 2);
    ...
    public static void gambleInterfaces(TextDrawingArea[] tda) {
        ...
        addText(id, "Random", tda, 2, 0xD5A043, false, true);
        ...
        addHoverButtonWSpriteLoader(id, 1069, 100, 25, "Select Option One", -1, id + 100, 5);
        setBounds(id, 140, 291, frame, game);
        frame++;
        addHoveredImageWSpriteLoaderTrans(id + 100, 1069, 100, 22, id + 101, 128);
        setBounds(id + 100, 140, 291, frame, game);
        frame++;
        id++;

        addHoverButtonWSpriteLoader(id, 1069, 100, 25, "Select Option Two", -1, id + 200, 5);
    ...
    public static void gambleBlackJack(TextDrawingArea[] tda) {
        ...
        addHoverButtonWSpriteLoader(index, 1064, 123, 48, "Stay", -1, index + 100, 5);
        setBounds(index, 115, 275, frame, main);
        frame++;

        addHoveredImageWSpriteLoader(index + 100, 1065, 123, 48, index + 100 + 1);
        setBounds(index + 100, 115, 275, frame, main);
        index++;
        frame++;

        addHoverButtonWSpriteLoader(index, 1066, 123, 48, "Hit", -1, index + 200, 5);
        setBounds(index, 275, 275, frame, main);
        frame++;

        addHoveredImageWSpriteLoader(index + 200, 1067, 123, 48, index + 200 + 1);
    ...
    public static void gambleNewInterfaces(TextDrawingArea[] tda) {
        ...
        addConfigButtonWSpriteLoader(id, 30891, 937, 938, 14, 15, "55x2", 1, 5, 1107, id + hover);
        setBounds(id, 31, 206, frame, tab);
        frame++;
        addHoveredImageWSpriteLoader(id + hover, 1033, 77, 27, id + hover + 1);
        setBounds(id + hover, 999, 999, frame, tab);
        frame++;
        id++;
        hover += 100;

        addConfigButtonWSpriteLoader(id, 30891, 937, 938, 14, 15, "Flower Poker", 2, 5, 1107, id + hover);
        setBounds(id, 31, 237, frame, tab);
        frame++;
        addHoveredImageWSpriteLoader(id + hover, 1033, 77, 27, id + hover + 1);
        setBounds(id + hover, 999, 999, frame, tab);
        frame++;
        ...
        addConfigButtonWSpriteLoader(id, 30891, 1032, 1034, 77, 27, "Dice Duel", 3, 5, 1107, id + hover);
        setBounds(id, 999, 999, frame, tab);
        frame++;
        addHoveredImageWSpriteLoader(id + hover, 1033, 77, 27, id + hover + 1);
        setBounds(id + hover, 999, 999, frame, tab);
        frame++;
        ...
        addConfigButtonWSpriteLoader(id, 30891, 937, 938, 14, 15, "Dice Duel", 4, 5, 1107, id + hover);
        setBounds(id, 31, 268, frame, tab);
        frame++;
        addHoveredImageWSpriteLoader(id + hover, 1033, 77, 27, id + hover + 1);
        setBounds(id + hover, 999, 999, frame, tab);
        frame++;
        ...
        addConfigButtonWSpriteLoader(id, 30891, 1032, 1034, 77, 27, "Frosty Flower", 5, 5, 1107, id + hover);
        setBounds(id, 999, 999, frame, tab);
        frame++;
        addHoveredImageWSpriteLoader(id + hover, 1033, 77, 27, id + hover + 1);
        setBounds(id + hover, 999, 999, frame, tab);
        ...
        addConfigButtonWSpriteLoader(id, 30891, 1032, 1034, 77, 27, "ABC Flowers", 6, 5, 1107, id + hover);
        setBounds(id, 999, 999, frame, tab);
        frame++;
        addHoveredImageWSpriteLoader(id + hover, 1033, 77, 27, id + hover + 1);
        setBounds(id + hover, 999, 999, frame, tab);
        ...
        addConfigButtonWSpriteLoader(id, 30891, 1032, 1034, 77, 27, "Hot or Cold", 7, 5, 1107, id + hover);
        setBounds(id, 999, 999, frame, tab);
        frame++;
        addHoveredImageWSpriteLoader(id + hover, 1033, 77, 27, id + hover + 1);
        setBounds(id + hover, 999, 999, frame, tab);
        ...
        addConfigButtonWSpriteLoader(id, 30891, 1032, 1034, 77, 27, "Random Game", 8, 5, 1107, id + hover);
        setBounds(id, 979, 999, frame, tab);
        frame++;
        addHoveredImageWSpriteLoader(id + hover, 1033, 77, 27, id + hover + 1);
        setBounds(id + hover, 999, 999, frame, tab);
        frame++;
        ...
        addText(id, "@or2@55x2", tda, 0, 0x989898, true, true);
        setBounds(id, 65, 209, frame, tab);
        frame++;
        id++;

        addText(id, "@or2@Flower Poker", tda, 0, 0x989898, true, true);
        setBounds(id, 80, 239, frame, tab);
        frame++;
        id++;

        addText(id, "@or2@Your Offer", tda, 1, 0x989898, true, true);
        setBounds(id, 79, 58, frame, tab);
        frame++;
        id++;

        addText(id, "@or2@Dice Duel", tda, 0, 0x989898, true, true);
        setBounds(id, 77, 272, frame, tab);
        frame++;
        id++;

        addText(id, "@or2@About The Game", tda, 2, 0x989898, true, true);
        setBounds(id, 337, 200, frame, tab);
        frame++;
        id++;

        addText(id, "@or2@Gambling Interface", tda, 2, 0x989898, true, true);
        setBounds(id, 250, 19, frame, tab);
        frame++;
        id++;
        ...
        addText(id, "@or2@Opponent Offer", tda, 1, 0x989898, true, true);
        setBounds(id, 415, 58, frame, tab);
        frame++;
        id++;
        ...
        setBounds(id, 346, 240, frame, tab);
        frame++;
        id++;
        ...
        addText(id, id + "", tda, 0, 0x989898, true, true);
        setBounds(id, 999, 999, frame, tab);
        frame++;
        id++;
        ...
        addHoverButtonWSpriteLoader(id, 1011, 114, 35, "Accept", -1, id + 190, 5);
        setBounds(id, 200, 90, frame, tab);
        frame++;
        addHoveredImageWSpriteLoader(id + 190, 1012, 114, 35, id + 191);
        setBounds(id + 190, 200, 90, frame, tab);
        frame++;
        id++;

        addHoverButtonWSpriteLoader(id, 1011, 114, 35, "Decline", -1, id + 290, 5);
        setBounds(id, 200, 140, frame, tab);
        frame++;
        addHoveredImageWSpriteLoader(id + 290, 1012, 114, 35, id + 291);
        setBounds(id + 290, 200, 140, frame, tab);
        frame++;
        id++;

        addText(id, "Decline", tda, 3, 0xff0000, true, true);
        setBounds(id, 255, 145, frame, tab);
        frame++;
        id++;

        addText(id, "Accept", tda, 3, 0x008000, true, true);
        setBounds(id, 255, 95, frame, tab);
        frame++;
        id++;
    }
    ...
    private static void bestInSlot() {
        ...
        String[] data = {"Attack bonus", "Stab: +0", "Slash: +0", "Crush: +0", "Magic: +0", "Range: +0", "Defence bonus", "Stab: +0", "Slash: +0", "Crush: +0", "Magic: +0", "Range: +0", "Other bonus", "Melee strength: +0", "Ranged strength: +0", "Magic damage: +0.0%", "Prayer: +0", "@yel@Attack speed: FAST"};
        RSInterface main = addInterface(STARTING_POINT);
        main.totalChildren(18 + data.length);
        main.child(0, STARTING_POINT + 1, 20, 10); // 1239 -> 1294
        addSpriteLoader(STARTING_POINT + 1, 1294);
        ...
        for (int i = 0; i < 10; i++) {
            ...
            addHoverableConfigSprite(STARTING_POINT + 2 + i, 1297, 1298, true, "Select", i, 3000);
        ...
        yPos = 2;
        for (int i = 0; i < 150; i++) {
            addHoverableConfigSprite(STARTING_POINT + 14 + i, 1295, 1296, true, "Select", i, 3200);
        ...
        yPos = 12;
        for (int i = 0; i < 150; i++) {
            addTextComponent(STARTING_POINT + 164 + i, "Some random text", fonts, 1, ColorConstants.RS_ORANGE, false, true, 0, 0);
        ...
        for (int i = 0; i < data.length; i++) {
            ...
            addTextComponent(STARTING_POINT + 315 + i, str, fonts, fontIndex, ColorConstants.RS_ORANGE, false, true, 0, 0);
            main.child(13 + i, STARTING_POINT + 315 + i, xPos + xOffset, last ? yPos + 4 : yPos);
            yPos += title ? 15 : 13;
        }

        addTextComponent(STARTING_POINT + 335, "Best in Slot Items", fonts, 2, ColorConstants.RS_ORANGE, false, true, 0, 0);
        main.child(31, STARTING_POINT + 335, 208, 20);
        addCloseButton(STARTING_POINT + 336);
        main.child(32, STARTING_POINT + 336, 471, 19);

        xPos = 28;
        int index = 0;
        for (int i = 0; i < 6; i += 2) {
            addHoverableConfigSprite(STARTING_POINT + 337 + index, 1300 + i, 1301 + i, true, "Select", i, 3300);
    ...
    public static RSInterface addHoverableSprite(int id, int mainSprite, int hoverSprite,
            boolean clickable, String tooltip) {
        RSInterface tab = interfaceCache[id] = new RSInterface();
        tab.id = id;
        tab.parentID = id;
        tab.type = 111;
    ...
    public static void EquipmentTab(TextDrawingArea[] tda) {
        ...
        addToggleButton1(24310, 1292, 3333, 15, 14, "Switch tab");
        //addConfigButtonWSpriteLoader(24310, 24310, 1289, 1290, 15, 14, "Switch tab", 0, 5, 3333);
        Interface.child(5, 24310, 171, 8);

        /* tab.child(3, 15109, 41+39+30, 212); */
    }

    public static void addToggleButton1(int id, int sprite, int setconfig, int width,
            int height, String s) {
        RSInterface rsi = addInterface(id);
    ...
    public static void addPouch(int ID, int r1[], int ra1, int r2, int lvl,
        ...
        addText(ID + 3, (new StringBuilder()).append("Level ")
                .append(lvl)
                .append(": ")
                .append(name)
                .toString(), 0xff981f, true, true, 52, 1);
        addText(ID + 4, "This item requires:", 0xaf6a1a, true, true, 52, 0);
        setBounds(ID + 2, 0, 0, 0, hover);
        setBounds(ID + 3, 90, 4, 1, hover);
        setBounds(ID + 4, 90, 19, 2, hover);
    ...
    public Model getAnimatedModel(int firstFrame, int secondFrame, boolean selected) {
        ...
        if (model == null)
            return null;
        if (secondFrame == -1 && firstFrame == -1 && model.groupedTriangleLabels == null)
            return model;
    ...
    public static void addTransparentLayer(int id, int layerColor, int layerTransparency) {
		...
		transparentLayer.setVisible(true); // open server
	}
    ...
    private static void customTasksInterface() {
        final int STARTING_POINT = 20285;
        RSInterface main = addInterface(STARTING_POINT);
        main.addSpriteLoader(STARTING_POINT + 1, 1349);
        main.totalChildren(23);
        main.child(0, STARTING_POINT + 1, 10, 10);
        addCloseButton(STARTING_POINT + 2);
        main.child(1, STARTING_POINT + 2, 472, 12);
        addTextComponent(STARTING_POINT + 3, "Custom Tasks", fonts, 2, ColorConstants.RS_ORANGE, false, true, 0, 0);
        main.child(2, STARTING_POINT + 3, 229, 13);
        addTextComponent(STARTING_POINT + 4, "Perks", fonts, 1, ColorConstants.RS_ORANGE, true, false, 0, 0);
        main.child(3, STARTING_POINT + 4, 256, 216);
        addTextComponent(STARTING_POINT + 5, "Rewards", fonts, 1, ColorConstants.RS_ORANGE, true, false, 0, 0);
        main.child(4, STARTING_POINT + 5, 420, 215);
        addTextComponent(STARTING_POINT + 6, "Tasks", fonts, 1, ColorConstants.RS_ORANGE, true, false, 0, 0);
        main.child(5, STARTING_POINT + 6, 98, 67);
        main.child(6, STARTING_POINT + 50, 15, 87);
        main.child(7, STARTING_POINT + 251, 185, 231);
        main.child(8, STARTING_POINT + 261, 345, 231);
        addHoverableConfigSprite(STARTING_POINT + 10, 1350, 1351, true, "NPC Tasks", 0, 2500);
        main.child(9, STARTING_POINT + 10, 18, 35);
        addHoverableConfigSprite(STARTING_POINT + 11, 1350, 1351, true, "Skilling Tasks", 1, 2500);
        main.child(10, STARTING_POINT + 11, 137, 35);
        addHoverableConfigSprite(STARTING_POINT + 12, 1350, 1351, true, "Minigame Tasks", 2, 2500);
        main.child(11, STARTING_POINT + 12, 256, 35);
        addHoverableConfigSprite(STARTING_POINT + 13, 1350, 1351, true, "Other Tasks", 3, 2500);
        main.child(12, STARTING_POINT + 13, 375, 35);

        addTextComponent(STARTING_POINT + 14, "NPC Tasks", fonts, 0, 0xe8edea, true, true, 0, 0);
        main.child(13, STARTING_POINT + 14, 76, 39);
        addTextComponent(STARTING_POINT + 15, "Skilling Tasks", fonts, 0, 0xe8edea, true, true, 0, 0);
        main.child(14, STARTING_POINT + 15, 197, 39);
        addTextComponent(STARTING_POINT + 16, "Minigame Tasks", fonts, 0, 0xe8edea, true, true, 0, 0);
        main.child(15, STARTING_POINT + 16, 312, 39);
        addTextComponent(STARTING_POINT + 17, "Other Tasks", fonts, 0, 0xe8edea, true, true, 0, 0);
        main.child(16, STARTING_POINT + 17, 431, 39);

        addTextComponent(STARTING_POINT + 18, "", fonts, 2, ColorConstants.RS_ORANGE, true, true, 0, 0);
        main.child(17, STARTING_POINT + 18, 346, 76);
        addTextComponent(STARTING_POINT + 19, "", fonts, 1, ColorConstants.RS_ORANGE, false, true, 0, 0);
        main.child(18, STARTING_POINT + 19, 212, 101);
        addTextComponent(STARTING_POINT + 20, "", fonts, 1, ColorConstants.RS_ORANGE, false, true, 0, 0);
        main.child(19, STARTING_POINT + 20, 212, 119);
        addTextComponent(STARTING_POINT + 21, "", fonts, 1, ColorConstants.RS_ORANGE, false, true, 0, 0);
        main.child(20, STARTING_POINT + 21, 212, 137);

        addProgressBar(STARTING_POINT + 22, 130, 30, 68, 0xFF0000, 0x276b23);
        main.child(21, STARTING_POINT + 22, 285, 166);
        addTextComponent(STARTING_POINT + 23, "68/100", fonts, 1, 16777215, false, true, 0, 0);
        main.child(22, STARTING_POINT + 23, 331, 174);


        RSInterface tasksScroll = addInterface(STARTING_POINT + 50);
        tasksScroll.width = 148;
        tasksScroll.height = 218;
        tasksScroll.scrollMax = 2300;

        tasksScroll.totalChildren(200);

        for (int i = 0; i < 100; i++) {
            addSpriteLoader(STARTING_POINT + 51 + i, i % 2 == 0 ? 1352 : 1353);
            tasksScroll.child(i, STARTING_POINT + 51 + i, 5, i * 23);
        }

        for (int i = 0; i < 100; i++) {
            addHoverableText(STARTING_POINT + 151 + i, "", "Select", fonts, 1, false, true, 140, 13, ColorConstants.RS_ORANGE, 0xffa55c, true);
            tasksScroll.child(100 + i, STARTING_POINT + 151 + i, 6, (i * 23) + 4);
        }


        RSInterface perksScroll = addInterface(STARTING_POINT + 251);
        perksScroll.width = 126;
        perksScroll.height = 73;
        perksScroll.scrollMax = 180;

        perksScroll.totalChildren(9);

        for (int i = 0; i < 9; i++) {
            addTextComponent(STARTING_POINT + 252 + i, "", fonts, 1, ColorConstants.RS_ORANGE, false, true, 0, 0);
            perksScroll.child(i, STARTING_POINT + 252 + i, 5, i * 20);
        }

        RSInterface rewardsScroll = addInterface(STARTING_POINT + 261);
        rewardsScroll.width = 126;
        rewardsScroll.height = 73;
        rewardsScroll.scrollMax = 252;

        rewardsScroll.totalChildren(1);
        addToItemGroup(STARTING_POINT + 262, 3, 7, 13, 4, false, null);
        rewardsScroll.child(0, STARTING_POINT + 262, 3, 2);
    }

    public static void addHoverableText(int id, String text, String tooltip, TextDrawingArea tda[], int idx,
            boolean center, boolean textShadowed, int width, int height, int disabledColor, int enabledColor, boolean clickable) {
        RSInterface widget = addInterface(id);
        widget.id = id;
        widget.parentID = id;
        widget.type = 4;
        widget.atActionType = clickable ? 1 : 0;
        widget.width = width;
        ...
        widget.disabledMouseOverColor = enabledColor;
        widget.tooltip = tooltip;
        // System.out.println("Disabled color: " + disabledColor + ", Enabled color: " + enabledColor);
    }
