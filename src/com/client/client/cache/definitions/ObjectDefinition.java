...
import com.client.client.OnDemandFetcher;
...
public final class ObjectDefinition {
	...
	public static ObjectDefinition forID(int i) {
		...
		try {
			...
			if (i > streamIndices.length || loadNew) {
				stream667.pos = streamIndices667[i];
			} else {
		...
		if (i == 2213) {
			objectDef.objectModelIDs = new int[] {55562};
			objectDef.actions = new String[5];
		...
		if ( i == 2009) {
			objectDef.name = "@whi@Raids #1 Entrance";
			objectDef.actions = new String[5];
			objectDef.objectModelIDs = new int[]{41996};
			objectDef.actions[0] = "@whi@Enter Raid -->";
		}
		if ( i == 2010) {
			objectDef.name = "@whi@Phase #2 Entrance";
			objectDef.actions = new String[5];
			objectDef.objectModelIDs = new int[]{41996};
			objectDef.actions[0] = "@whi@Enter Phase -->";
		}
		if ( i == 2013) {
			objectDef.name = "@whi@Vote Boss Well";
			objectDef.actions = new String[] { "Investigate", "Contribute", null, null, null };
			objectDef.objectModelIDs = new int[]{42007};
			objectDef.actions[0] = "@whi@Fill the Well";
		}
		if (i == 3192) {
			objectDef.actions = new String[5];
		...
		if ( i == 2014) {
			objectDef.name = "@whi@Pokemon Raids Chest";
			objectDef.actions = new String[5];
			objectDef.objectModelIDs = new int[]{42008};
			objectDef.actions[0] = "@whi@Open -->";
		}
		if ( i == 2043) {
			objectDef.name = "@gre@Anime Raids Chest";
			objectDef.actions = new String[5];
			objectDef.objectModelIDs = new int[]{50061};
			objectDef.actions[0] = "@whi@Open -->";
		}
		if ( i == 2044) {
			objectDef.name = "@gre@Silver Raids Chest";
			objectDef.actions = new String[5];
			objectDef.objectModelIDs = new int[]{50287};
			objectDef.actions[0] = "@whi@Open -->";
		
		}
		if (i == 2006) {
			objectDef.name = "Aoe zone chest";
			objectDef.objectModelIDs = new int[] { 50622 };
			objectDef.actions = new String[5];
			objectDef.actions[0] = "@whi@Open -->";
			
		}
		if (i == 4001) {
			objectDef.name = "Raids Six Chest";
			objectDef.objectModelIDs = new int[] { 50661 };
			objectDef.actions = new String[5];
			objectDef.actions[0] = "@whi@Open -->";
			
		}
		if (i == 1992) {
			objectDef.name = "Diamond Raids Chest";
			objectDef.objectModelIDs = new int[] { 50661 };
			objectDef.actions = new String[5];
			objectDef.actions[0] = "@whi@Open -->";
		...
		if (i == 1993) {
			objectDef.name = "Drop Party Chest";
			objectDef.objectModelIDs = new int[] { 50661 };
			objectDef.actions = new String[5];
			objectDef.actions[0] = "@whi@Open -->";
		...
		if ( i == 2008) {
			objectDef.name = "@gre@Mortal Kombat Raids Chest";
			objectDef.actions = new String[5];
			objectDef.objectModelIDs = new int[]{50572};
			objectDef.actions[0] = "@whi@Open -->";
		}
		if ( i == 2007) {
			objectDef.name = "@gre@Golden Raids Chest";
			objectDef.actions = new String[5];
			objectDef.objectModelIDs = new int[]{22002};
			objectDef.actions[0] = "@whi@Open -->";
		}
		if ( i == 2011) {
			objectDef.name = "@whi@Phase #3 Entrance";
			objectDef.actions = new String[5];
			objectDef.objectModelIDs = new int[]{41996};
			objectDef.actions[0] = "@whi@Enter Phase -->";
		}
		if ( i == 2012) {
			objectDef.name = "@whi@Raids Exit";
			objectDef.actions = new String[5];
			objectDef.objectModelIDs = new int[]{41996};
			objectDef.actions[0] = "@whi@Exit Raid -->";
		}
		if ( i == 3010) {
			objectDef.name = "@whi@Anime Raids Entrance";
			objectDef.actions = new String[5];
			objectDef.objectModelIDs = new int[]{22000};
			objectDef.actions[0] = "@whi@Enter Raid -->";
		}
		if ( i == 3000) {
			objectDef.name = "@whi@Plat Raids Entrance";
			objectDef.actions = new String[5];
			objectDef.objectModelIDs = new int[]{50660};
			objectDef.actions[0] = "@whi@Enter Raid -->";
			objectDef.originalModelColors = new int[] { 9 };
			objectDef.modifiedModelColors = new int[] { 18 };
		}
		if ( i == 3001) {
			objectDef.name = "@whi@Diamond Raids Entrance";
			objectDef.actions = new String[5];
			objectDef.objectModelIDs = new int[]{50660};
			objectDef.actions[0] = "@whi@Enter Raid -->";
		}
		if ( i == 3012) {
			objectDef.name = "@blu@Silver Donator Raids Entrance";
			objectDef.actions = new String[5];
			objectDef.objectModelIDs = new int[]{22001};
			objectDef.actions[0] = "@whi@Enter Raid -->";
		}
		if ( i == 3013) {
			objectDef.name = "@whi@Mortal Kombat Raids Entrance";
			objectDef.actions = new String[5];
			objectDef.objectModelIDs = new int[]{50573};
			objectDef.actions[0] = "@whi@Enter Raid -->";
		}
		if ( i == 3009) {
			objectDef.name = "@whi@Golden Raids Entrance";
			objectDef.actions = new String[5];
			objectDef.objectModelIDs = new int[]{50575};
			objectDef.actions[0] = "@whi@Enter Raid -->";
		}
		...
		if(i == 3008) {
			objectDef.actions = new String[5];
			objectDef.name = "@cya@Upgrade Machine";
			objectDef.actions[0] = "@whi@View";
			objectDef.objectModelIDs = new int[]{41644};
			objectDef.sizeY = 1;
			objectDef.sizeX = 1;
	    }
		if(i == 4002) {
			objectDef.actions = new String[5];
			objectDef.name = "@cya@Fuser Machine";
			objectDef.actions[0] = "@whi@View";
			objectDef.objectModelIDs = new int[]{50703};
			objectDef.sizeY = 1;
			objectDef.sizeX = 1;
	    }
		if(i == 4005) {
			objectDef.actions = new String[5];
			objectDef.name = "@gre@Group Ironman Station";
			objectDef.actions[0] = "@whi@Create Group";
			objectDef.actions[1] = "@whi@Group Bank";
			objectDef.actions[2] = "@whi@Leaderboard";
			objectDef.objectModelIDs = new int[]{59554};
			objectDef.sizeX = 1;
			objectDef.sizeY = 1;
		}
		if(i == 11098) {
			objectDef.actions = new String[5];
			objectDef.name = "@cya@Loot Item";
			objectDef.actions[0] = "@whi@Open the loot";
			objectDef.objectModelIDs = new int[]{41957};
			objectDef.sizeY = 1;
			objectDef.sizeX = 1;
	    }
		if(i == 11099) {
			objectDef.actions = new String[5];
			objectDef.name = "@red@Loot Item";
			objectDef.actions[0] = "@bla@Open the loot";
			objectDef.objectModelIDs = new int[]{41993};
			objectDef.sizeY = 1;
			objectDef.sizeX = 1;
	    }
		if (i == 2783) {
		...
		if (i == 15_000) {
			ObjectDefinition wall = ObjectDefinition.forID(11951);
			objectDef.objectModelIDs = new int[]{50929};
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
			objectDef.name = "Cash Rock";
			...
			objectDef.animationID = wall.animationID;
		}
		if (i == 7459) {
			ObjectDefinition wall = ObjectDefinition.forID(42029);
		...
		switch (i) {
		case 5273:
			objectDef.name = "Donor Chest #1";
			objectDef.objectModelIDs = new int[] { 24711 };
			break;
		case 5274:
			objectDef.name = "Donor Chest #2";
			ObjectDefinition wall = ObjectDefinition.forID(5273);
			objectDef.objectModelIDs = new int[] { 24711 };
			objectDef.actions = wall.actions;
			break;
		case 5275:
			objectDef.name = "Donor Chest #3";
			ObjectDefinition wall2 = ObjectDefinition.forID(5273);
			objectDef.objectModelIDs = new int[] { 24711 };
			objectDef.actions = wall2.actions;
			break;
		case 5278:
			objectDef.name = "Donor Chest #4";
			ObjectDefinition wall3 = ObjectDefinition.forID(5273);
			objectDef.objectModelIDs = new int[] { 24711 };
			objectDef.actions = wall3.actions;
			break;
		case 5279:
			objectDef.name = "Donor Chest #5";
			ObjectDefinition wall4 = ObjectDefinition.forID(5273);
			objectDef.objectModelIDs = new int[] { 24711 };
			objectDef.actions = wall4.actions;
			break;
	...
	public static String objModels(int objectID) {
	    int[] inv = forID(objectID).objectModelIDs;
	    String name = forID(objectID).name;
	    	
	    	return "(<col=800000000>"+objectID+"</col>) - [inv: <col=800000000>"
	    	+ Arrays.toString(inv)+"</col>]";
	}
