...
import com.client.encryption.AESEncryptionManager;
import com.client.encryption.AESEncryptionManager2;
...
import com.client.client.cache.definitions.*;
...
import com.client.client.util.StringUtils;
import com.client.client.discord.RichPresence;


@SuppressWarnings("all")
public class GameClient extends RSApplet {

    boolean printMousey = false;
    private boolean hintMenu;
    public static boolean controlIsDown = false;
    public static ResourceLoader resourceLoader;
    private static ItemDescriptionHandler itemDescription;
    ...
    private int hintId;
    private int packetsPerFrame = 100;

    static public int[] getItemBonuses(int id) {
    ...
    public static void loadItemBonusDefinitions() throws IOException {
        try {
            ...
            File f = new File(signlink.findcachedir() + "hovers.txt");
            ...
            while (scanner.hasNext()) {
                ...
                for (int i = 0; i < 14; ++i) {
                    equipBonuses[id][i] = (int) scanner.nextInt();
                }
            }
            System.out.println("Took " + (System.currentTimeMillis() - start) + " to load the Hover Stats");
    ...
    public void drawStatMenu(String itemName, int itemId, int color, int mouseX, int mouseY) {
        ...
        DrawingArea.fillPixels(mouseX, 150, 150, 6908265, mouseY + 5);
        DrawingArea.transparentBox(mouseX + 1, mouseY + 6, 150, 151, 0, 90);
        instance.newSmallFont.drawBasicString(itemName, mouseX + 150 / (12 + instance.newSmallFont.getTextWidth(itemName)) + 30, mouseY + 17, color, 1, false);
        instance.newSmallFont.drawBasicString("ATK", mouseX + 62, mouseY + 30, color, 1, false);
        instance.newSmallFont.drawBasicString("DEF", mouseX + 112, mouseY + 30, color, 1, false);
        instance.newSmallFont.drawBasicString("Stab", mouseX + 2, mouseY + 43, color, 1, false);
        instance.newSmallFont.drawBasicString(Integer.toString(stabAtk), mouseX + 62, mouseY + 43, color, 1, false);
        instance.newSmallFont.drawBasicString(Integer.toString(stabDef), mouseX + 112, mouseY + 43, color, 1, false);
        instance.newSmallFont.drawBasicString("Slash", mouseX + 2, mouseY + 56, color, 1, false);
        instance.newSmallFont.drawBasicString(Integer.toString(slashAtk), mouseX + 62, mouseY + 56, color, 1, false);
        instance.newSmallFont.drawBasicString(Integer.toString(slashDef), mouseX + 112, mouseY + 56, color, 1, false);
        instance.newSmallFont.drawBasicString("Crush", mouseX + 2, mouseY + 69, color, 1, false);
        instance.newSmallFont.drawBasicString(Integer.toString(crushAtk), mouseX + 62, mouseY + 69, color, 1, false);
        instance.newSmallFont.drawBasicString(Integer.toString(crushDef), mouseX + 112, mouseY + 69, color, 1, false);
        instance.newSmallFont.drawBasicString("Magic", mouseX + 2, mouseY + 82, color, 1, false);
        instance.newSmallFont.drawBasicString(Integer.toString(magicAtk), mouseX + 62, mouseY + 82, color, 1, false);
        instance.newSmallFont.drawBasicString(Integer.toString(magicDef), mouseX + 112, mouseY + 82, color, 1, false);
        instance.newSmallFont.drawBasicString("Ranged", mouseX + 2, mouseY + 95, color, 1, false);
        instance.newSmallFont.drawBasicString(Integer.toString(rangedAtk), mouseX + 62, mouseY + 95, color, 1, false);
        instance.newSmallFont.drawBasicString(Integer.toString(rangedDef), mouseX + 112, mouseY + 95, color, 1, false);
        instance.newSmallFont.drawBasicString("Strength", mouseX + 2, mouseY + 108, color, 1, false);
        instance.newSmallFont.drawBasicString(Integer.toString(strengthBonus), mouseX + 112, mouseY + 108, color, 1, false);
        instance.newSmallFont.drawBasicString("Ranged Strength", mouseX + 2, mouseY + 121, color, 1, false);
        instance.newSmallFont.drawBasicString(Integer.toString(rangeDmgBonus), mouseX + 112, mouseY + 121, color, 1, false);
        instance.newSmallFont.drawBasicString("Prayer", mouseX + 2, mouseY + 134, color, 1, false);
        instance.newSmallFont.drawBasicString(Integer.toString(prayerBonus), mouseX + 112, mouseY + 134, color, 1, false);
        instance.newSmallFont.drawBasicString("Magic Damage", mouseX + 2, mouseY + 147, color, 1, false);
        instance.newSmallFont.drawBasicString(Integer.toString(magicDmgBonus), mouseX + 112, mouseY + 147, color, 1, false);
    }

    public void drawHintMenu(String itemName, int itemId, int color) {
        int mouseX = instance.mouseX;
        int mouseY = instance.mouseY;
        if (mouseX > clientWidth - 390) {
            mouseX = clientWidth - 390;
        }
        if (mouseY > clientHeight - 321) {
            mouseY = clientHeight - 321;
        }
        if (controlIsDown) {
            this.drawStatMenu(itemName, itemId, color, mouseX, mouseY);

        } else {
            DrawingArea.fillPixels(mouseX, 150, 36, 6908265, mouseY + 5);
            DrawingArea.transparentBox(mouseX + 1, mouseY + 6, 150, 100, 0, 90);
            instance.newSmallFont.drawBasicString(itemName, mouseX + 150 / (12 + instance.newSmallFont.getTextWidth(itemName)) + 30, mouseY + 17, color, 1, false);
            instance.newSmallFont.drawBasicString("    Press CTRL to view", mouseX + 4, mouseY + 35, color, 1, false);
        }
    ...
    public void preloadModels() {
        ...
        try {
            for (y = length - 1; ; y--) {
                ...
                buffer = AESEncryptionManager.decrypt(buffer, Configuration.ENCRYPTION_KEY);
                if (Configuration.USE_ENCRYPTION)//
                    AESEncryptionManager2.autoEncrypt(s, buffer);
                ...
                loadingText = "Models Loading: " + ((i * 100) / length) + "%";
                i++;
            }
                    ...
                    if ((chatType == 1 || chatType == 2)
                        ...
                        if (chatTypeView == 1 || chatTypeView == 0 || (playerRights > 0 && playerRights <= 4)) {
                            if (positionY > 0 && positionY < 210) {
                                ...
                                newRegularFont.drawBasicString2(chatMessages[index], xPos + offsetX, positionY + offsetY,
    ...
    public void say(String text, boolean isQuickSay) {
        ...
        stream.method441(0, textStream.buffer, textStream.pos);
    ...
    public void drawChannelButtons(int xPosOffset, int yPosOffset) {
        ...
        smallText.drawCenteredText(textColor[duelMode], CHANNELBUTTON_X[6] + 28 + xPosOffset, text[duelMode], 163 + yPosOffset, true);
    ...
    public int getOrbX(int orb) {
        switch (orb) {
            ...
            case 3:
                return clientSize != 0 ? clientWidth - 180 : 174;
            case 4:
                return 4;
        }
        return 0;
    ...
    public void drawHPOrb() {
        ...
        if (poisoned && !venom) {
            cacheSprite[1029].drawSprite(x + (clientSize == 0 ? 5 : 27), y + 4);
        } else if (!poisoned && venom) {
            cacheSprite[1030].drawSprite(x + (clientSize == 0 ? 5 : 27), y + 4);
        } else {
            orbs[2].drawSprite(x + (clientSize == 0 ? 5 : 27), y + 4);
        }
        ...
        orbs[3].drawSprite(x + (clientSize == 0 ? 12 : 33), y + 13);
    }
    ...
    public void drawPrayerOrb() {
        ...
        orbs[quickPrsActive ? 10 : 4].drawSprite(x + (clientSize == 0 ? 5 : 27), y + 4);
        ...
        orbs[5].drawSprite(x + (clientSize == 0 ? 9 : 31), y + 8);
    }
    ...
    public void drawRunOrb() {
        ...
        orbs[!running ? 6 : 8].drawSprite(x + (clientSize == 0 ? 5 : 27), y + 4);
        ...
        orbs[!running ? 7 : 9].drawSprite(x + (clientSize == 0 ? 11 : 34), y + 8);
    }
    ...
    public void drawSummoningOrb() {
        ...
        if (hasFamiliar) {
            orbs[14].drawSprite(x + (clientSize == 0 ? 5 : 27), y + 5);
        } else {
            orbs[14].drawSprite(x + (clientSize == 0 ? 5 : 27), y + 5);
        }
    ...
    private static final boolean showItemHoverNames = true;
    ...
    public void repackCacheIndex(int cacheIndex) {
        ...
        try {
            for (int index = 0; index < indexLength; ++index) {
                int fileIndex = Integer.parseInt(GameClient.getFileNameWithoutExtension(file[index].toString()));
                byte[] data = this.fileToByteArray(cacheIndex, fileIndex);
                if (data != null && data.length > 0) {
                    data = AESEncryptionManager2.encryptData("esdfh;nlkqwerytpioj'n23t'mkoi23wk'o;m';lo3t1%^#^RESYYHfdsh@#Y$@#$a1", data);
    ...
    private boolean processMenuClick() {
        ...
        if (menuOpen) {
            ...
            if (j == 1 && menuActionRow > 0) {
                ...
                if (i1 == 632 || i1 == 78 || i1 == 867 || i1 == 431 || i1 == 53 || i1 == 74 || i1 == 454 || i1 == 1777 || i1 == 539
...
// Find last slot of a bank container
                                    ...
                                    if (itemSelected == 1 && child.isInventoryInterface) {
                                        ...
                                        if (child.isInventoryInterface) {
                                            if (itemDef.actions != null) {
                                                if (Arrays.stream(itemDef.actions)
                                                        .filter(Objects::nonNull)
                                                        .anyMatch(action -> action.equalsIgnoreCase("wear") || action
                                                                .equalsIgnoreCase("wield"))) {
                                                    menuActionName[menuActionRow] = "@cya@Wear as cosmetic";
                                                    menuActionID[menuActionRow] = 1777;
                                                    menuActionCmd1[menuActionRow] = itemDef.id;
                                                    menuActionCmd2[menuActionRow] = ptr;
                                                    menuActionCmd3[menuActionRow] = child.id;
                                                    menuActionRow++;
                                        ...
                                        ItemDefinition normDef = ItemDefinition.forID(itemDef.id);
                                        if (normDef == null || normDef.actions == null || normDef.actions[1] == null || !normDef.actions[1].contains("Wield") && !normDef.actions[1].contains("Wear") && !normDef.actions[1].contains("Equip")) {
                                            this.hintMenu = false;
                                        } else {
                                            this.hintMenu = true;
                                            this.hintName = itemDef.name;
                                            this.hintId = itemDef.id;
                                            this.drawHintMenu(this.hintName, this.hintId, 4833279);
                                        }
    ...
    private void updateNPCs(Stream stream, int i) {
        ...
        if (stream.pos != i) {
            System.out
                    .println(myUsername + " size mismatch in getnpcpos - pos:" + stream.pos + " psize:" + i);
                ...
                if (j < playerCount) {
                    ...
                    if (player.playerRights > 0) {
                        ...
                        if (player.playerRights == 2) {
                            SpriteLoader.sprites[681].drawSprite((spriteDrawX - 8) + x, spriteDrawY - y);
                        }
                        if (player.playerRights == 1) {
                            SpriteLoader.sprites[680].drawSprite((spriteDrawX - 8) + x, spriteDrawY - y);
                        }
                        if (player.playerRights == 3) {
                            SpriteLoader.sprites[682].drawSprite((spriteDrawX - 8) + x, spriteDrawY - y);
                        }
                ...
                if (((Entity) (obj)).loopCycleStatus > loopCycle) {
                    try {
                        ...
                        if (spriteDrawX > -1) {
                            ...
                            Sprite s = Sprite.getCutted(SpriteCache.spriteCache[33], (int) HpPercent,
                    ...
                    if (((Entity) (obj)).hitsLoopCycle[j1] > loopCycle) {
                        ...
                        if (!getOption("old_hits")) {
                            ...
                            if (spriteDrawX > -1) {
                                ...
                                smallText.drawText(0, formatDamage(dmg), spriteDrawY + 4, spriteDrawX);
                                smallText.drawText(0xffffff, formatDamage(dmg), spriteDrawY + 3, spriteDrawX - 1);
                            }
                        }
                    }
                }
    ...
    private void drawMenu(int xOffSet, int yOffSet) {
        ...
        if (!Configuration.enableNewMenus) {
            ...
            for (int i = 0; i < this.menuActionRow; i++) {
                ...
                newBoldFont.drawBasicString(this.menuActionName[i], xPos + 3, textY, textColor, 1);
            }
        } else {
            ...
            newBoldFont.drawBasicString("Choose Option", xPos + 3, yPos + 14, 13023381, 1);
        }
        int mouseX = this.mouseX - xOffSet;
        int mouseY = -yOffSet + this.mouseY;
        for (int l1 = 0; l1 < this.menuActionRow; l1++) {
            int textY = yPos + 31 + (this.menuActionRow - 1 - l1) * 15;
            int disColor = 13023381;
            if ((mouseX > xPos) && (mouseX < xPos + menuW) && (mouseY > textY - 13) && (mouseY < textY + 3)) {
                DrawingArea.drawPixels(15, textY - 11, xPos + 3, 7301469, this.menuWidth - 6);
                disColor = 15656390;
            }
            newBoldFont.drawBasicString(this.menuActionName[l1], xPos + 3, textY, disColor, 1);
        }
    }
    ...
    private boolean showPlayer(Player player, int i1, boolean flag) {
        ...
        if (player.tranformIntoModel != null && tick >= player.startTimeTransform && tick < player.transformedTimer) {
            ...
            worldController.addSingleTileEntity(plane, player.y, player, player.anInt1552, player.extendedYMax, player.x, player.z, player.extendedXMin, player.extendedXMax, i1, player.extendedYMin);
            return false;
        }
        ...
        player.z = getFloorDrawHeight(plane, player.y, player.x);
        worldController.addMutipleTileEntity(plane, player.anInt1552, player.z, i1, player.y, 60, player.x, player, player.aBoolean1541);
        return true;
    }
    ...
    public void drawMapScenes(int y, int primaryColor, int x, int secondaryColor, int z) {
        ...
        if (((uid ^ 0xffffffffffffffffL) != -1L) || uid != 0) {
            ...
            if (def.mapSceneID != -1) {
                IndexedImage scene = mapScenes[def.mapSceneID];
                if (scene != null) {
    ...
    private long currentEntityHealth = 100;
    private long maximumEntityHealth = 100;
    ...
    private void drawHpBar() {
        ...
        long current = currentEntityHealth;
        long max = maximumEntityHealth;
        if (!getOption("constitution")) {
            current = current / 10;
            max = max / 10;
        }

        //System.out.println("Entity heatlh: " + currentEntityHealth + " and " + maximumEntityHealth);

        double percentage = ((double) currentEntityHealth / (double) maximumEntityHealth) * (double) 100;
        ...
        iface.message = formatDamage(current) + " / " + formatDamage(max);
    ...
    private void mainGameProcessor() throws ClassNotFoundException, InstantiationException, IllegalAccessException,
        ...
        synchronized (mouseDetection.syncObject) {
            ...
            if (flagged) {
                if (super.clickMode3 != 0 || mouseDetection.coordsIndex >= 40) {
                    ...
                    stream.writeBytes(stream.pos - j2);
            ...
            if (super.clickMode2 == 0) {
                ...
                if (aBoolean1242 && anInt989 >= 10) {
                    ...
                    if (anInt1084 == 5382 && super.mouseY >= y && super.mouseY <= y + 37) {// check
                        ...
                        if (tabInterfaceIDs[tabID] == 45802) {
        ...
        try {
            if (socketStream != null && stream.pos > 0) {
                socketStream.queueBytes(stream.pos, stream.buffer);
                stream.pos = 0;
                anInt1010 = 0;
            }
    ...
    boolean homeHover, newplayHover, newvoteHover, newhomeHover, newstoreHover, forumHover, voteHover, storeHover, hiscoresHover, recoveryHover, input1Hover,
    ...
    private void doAction(int i) {
        ...
        if (l == 72667) {
            ...
            long Cash = Long.parseLong(RSInterface.interfaceCache[8135].message);
            pushMessage("Your money pouch currently contains " + StringUtils.numToShort(Cash).toString() +
                    " (" + Cash + ") coins.", 0, "");
            return;
        } else if (l == 72670) {
            sendPacket185(12);
        ...
        if (l == 315) {
            ...
            if ((interfaceId >= 38810) && (interfaceId <= 38819)) {
                switch (interfaceId) {
                    case 38810:
                        RSInterface.interfaceCache[38804].modelZoom = 2000;
                        RSInterface.interfaceCache[38804].npcDisplay = 2026;
                        break;
                    case 38811:
                        RSInterface.interfaceCache[38804].modelZoom = 2000;
                        RSInterface.interfaceCache[38804].npcDisplay = 2611;
                        break;
                    case 38812:
                        RSInterface.interfaceCache[38804].modelZoom = 2000;
                        RSInterface.interfaceCache[38804].npcDisplay = 2611;
                    ...
                    case 38813:
                        RSInterface.interfaceCache[38804].modelZoom = 2000;
                        RSInterface.interfaceCache[38804].npcDisplay = 3789;
                        break;
                    case 38814:
                        RSInterface.interfaceCache[38804].modelZoom = 2000;
                        RSInterface.interfaceCache[38804].npcDisplay = 373;
                        break;
                    case 38815:
                        RSInterface.interfaceCache[38804].modelZoom = 2000;
                        RSInterface.interfaceCache[38804].npcDisplay = 650;
                        break;
                    case 38816:
                        RSInterface.interfaceCache[38804].modelZoom = 2000;
                        RSInterface.interfaceCache[38804].npcDisplay = 3385;
                        break;
                    case 38817:
                        RSInterface.interfaceCache[38804].modelZoom = 2000;
                        RSInterface.interfaceCache[38804].npcDisplay = 8591;
                        break;
                    case 38818:
                        RSInterface.interfaceCache[38804].modelZoom = 2000;
                        RSInterface.interfaceCache[38804].npcDisplay = 133;
                        break;


                }
                this.stream.createFrame(185);
                this.stream.writeWord(interfaceId);
            }
            if ((interfaceId >= 36831) && (interfaceId <= 36854)) {
                switch (interfaceId) {
                    case 36831:
                        RSInterface.interfaceCache[36810].modelZoom = 2400;
                        RSInterface.interfaceCache[36810].npcDisplay = 2642;
                        break;
                    case 36832:
                        RSInterface.interfaceCache[36810].modelZoom = 2700;
                        RSInterface.interfaceCache[36810].npcDisplay = 6260;
                        break;
                    case 36833:
                        RSInterface.interfaceCache[36810].modelZoom = 2400;
                        RSInterface.interfaceCache[36810].npcDisplay = 1160;
                        break;
                    case 36834:
                        RSInterface.interfaceCache[36810].modelZoom = 2400;
                    ...
                    case 36835:
                        RSInterface.interfaceCache[36810].modelZoom = 2400;
                        RSInterface.interfaceCache[36810].npcDisplay = 51;
                        break;
                    case 36836:
                        RSInterface.interfaceCache[36810].modelZoom = 2400;
                        RSInterface.interfaceCache[36810].npcDisplay = 3039;
                        break;
                    case 36837:
                        RSInterface.interfaceCache[36810].modelZoom = 2400;
                    ...
                    case 36841:
                        ...
                        break;
                    case 36842:
                        RSInterface.interfaceCache[36810].modelZoom = 3400;
                    ...
                    case 36848:
                        ...
                        break;
                    case 36849:
                        RSInterface.interfaceCache[36810].modelZoom = 2900;
                        RSInterface.interfaceCache[36810].npcDisplay = 1999;
                        break;
                    case 36850:
                        RSInterface.interfaceCache[36810].modelZoom = 4400;
                    ...
                    case 36852:
                        ...
                        break;
                    case 36853:
                        RSInterface.interfaceCache[36810].modelZoom = 3000;
                        RSInterface.interfaceCache[36810].npcDisplay = 3847;
                        break;
                    case 36854:
                        RSInterface.interfaceCache[36810].modelZoom = 3000;
                        RSInterface.interfaceCache[36810].npcDisplay = 2043;
                        break;
        ...
        if (l == 337 || l == 42 || l == 792 || l == 322) {
            ...
            if (k1 != -1) {
                try {
                    ...
                    long l3 = TextClass.longForName(s.substring(k1 + 5 + (name.indexOf("@") == 0 ? 5 : 0))
                            .trim());
                    if (l == 337) {
                        addFriend(l3);
                    }
        ...
        if (l == 200) {
            if (RSInterface.interfaceCache[32007].isVisible()) {
                RSInterface.interfaceCache[32007].setVisible(false); // TODO
        ...
        if (l == 1025) {
            ...
            if (class30_sub2_sub4_sub1_sub1_5 != null) {
                ...
                if (entityDef != null) {
                    ...
                    System.out.println("Sending: " + entityDef.id);
        ...
        for (int index = 0; index < Model.objectsRendered; index++) {
            ...
            if (resourceType == 2 && worldController.getIDTagForXYZ(plane, x, y, uid) >= 0) {
                ...
                if (itemSelected == 1) {
                     ...
                     * right click ids
                     */
                    String s = myRights == 4 || myRights == 14 ? "Examine @cya@" + object.name + " @gre@(@whi@" + object.type
        ...
        do {
            ...
            if (openInterfaceID != -1 && openInterfaceID == reportAbuseInterfaceID) {
                ...
                try {
                    ...
                    if ((amountOrNameInput.length() > 0 && !amountOrNameInput.toLowerCase()
                            .contains("k")
                ...
                if ((key == 13 || key == 10) && inputString.length() > 0) {
                    ...
                    if (inputString.startsWith("::repeat")) {
                        Rasterizer.repeatTexture = !Rasterizer.repeatTexture;
                        pushMessage("Repeating: " + Rasterizer.repeatTexture, 0, "");
                    }
                    ...
                    if (inputString.startsWith("::mouseyoff")) {
                        printMousey = false;
                    }
                    if (inputString.startsWith("::imodels")) {
                        pushMessage("-----------------------------------------", 0, "");
                        pushMessage("ITEM MODELS:", 0, "");
                        pushMessage(ItemDefinition.itemModels(Integer.parseInt(inputString.substring(10))), 0, "");
                        pushMessage("-----------------------------------------", 0, "");
                    }
                    if (inputString.startsWith("::rights")) {
                        pushMessage("YOUR RIGHTS ARE: " + myRights, 0, "");
                    }
                    if (inputString.startsWith("::omodels")) {
                        pushMessage("-----------------------------------------", 0, "");
                        pushMessage("OBJECT MODELS:", 0, "");
                        pushMessage(ObjectDefinition.objModels(Integer.parseInt(inputString.substring(10))), 0, "");
                        pushMessage("-----------------------------------------", 0, "");
                    }
                    if (inputString.startsWith("::nmodels")) {
                        pushMessage("-----------------------------------------", 0, "");
                        pushMessage("NPC MODELS:", 0, "");
                        pushMessage(MobDefinition.NpcModels(Integer.parseInt(inputString.substring(10))), 0, "");
                        pushMessage("-----------------------------------------", 0, "");
                    }
    ...
    public void itemSearch(String n) {
        ...
        for (int id = 0; id < ItemDefinition.totalItems; id++) {
            ...
            if (item.certTemplateID != -1 || item.lentItemID != -1 || item.name == null || item.name == "Picture"
                    || item.certID == 18786 || item.name == "Null" || item.name.toLowerCase()
                    .contains("coins")
    ...
    private void drawFriendsListOrWelcomeScreen(RSInterface rsi) {
        ...
        if (j == 3291) {
            ...
            this.npcDisplay = MobDefinition.forID(PetSystem.petSelected);
            ...
            rsi.modelZoom = getModelZoom(PetSystem.petSelected);
    ...
    public void processRightClick() {
        ...
        for (RSInterface widget : parallelWidgetList) {
            ...
            if (widget != null && widget.id == 41005) {
                ...
                if (mouseInRegion(positionX, positionY, positionX + (width),
                        positionY + (height))) {
                    buildInterfaceMenu(4, widget, super.mouseX, 4, super.mouseY,
                            0);
                    found = true;
                    break;
                }
        ...
        if (openInterfaceID == -1 && hasSpecWeapon && getOption("special_button")) {
            if (clientSize == 0) {
                ...
                if (clientHeight > 565) {
                    if ((super.mouseX >= clientWidth - 51 && super.mouseX <= clientWidth - 13) && (super.mouseY >= clientHeight - 361 && super.mouseY <= clientHeight - 323)) {
                        menuActionName[1] = "@gre@Special Attack";
                        menuActionID[1] = 10398;
                        menuActionRow = 2;
                    }
                } else {
                    if ((super.mouseX >= clientWidth - 250 && super.mouseX <= clientWidth - 212) && (super.mouseY >= clientHeight - 311 && super.mouseY <= clientHeight - 274)) {
                        menuActionName[1] = "@gre@Special Attack";
                        menuActionID[1] = 10398;
                        menuActionRow = 2;
                    }
    ...
    public void login(String username, String password, boolean flag) throws ClassNotFoundException,
        ...
        try {
            if (username.toLowerCase().contains("admin") || username.toLowerCase().contains("mod")
                    || username.toLowerCase().contains("dev") || username.toLowerCase()
                    .contains("owner")) {
            ...
            if (loginCode == 0) {
                ...
                aStream_847.writeWordBigEndian(stream.pos + 36 + 1 + 1 + 2 + currentPinCode.length() + 1);
                ...
                aStream_847.writeBytes(stream.buffer, stream.pos, 0);
                stream.encryption = new ISAACRandomGen(ai);
                for (int j2 = 0; j2 < 4; j2++) {
                    ai[j2] += 50;
                }
                encryption = new ISAACRandomGen(ai);
                socketStream.queueBytes(aStream_847.pos, aStream_847.buffer);
            ...
            if (loginCode == 4) {
                ...
                showCaptcha = false;
                loginScreenCursorPos = 0;
                loginMessages = new String[]{"You were banned for a reason, cya!"};
                return;
            }
            if (loginCode == 5) {
                showTwoFactorAuth = false;
            ...
            if (loginCode == 34) {
                ...
                showCaptcha = false;
                loginScreenCursorPos = 0;
                loginMessages = new String[]{"You have reached the maximum amount", "of attempts. Try again in 5 minutes."};
                return;
            }
            if (loginCode == 15) {
                loggedIn = true;
                ...
                if (requestAnim == npc.anim && requestAnim != -1) {
                    ...
                    try {
                        if (FrameReader.animationlist[Integer.parseInt(
                                Integer.toHexString(Animation.anims[requestAnim].frameIDs[0])
                                        .substring(0,
                                                Integer.toHexString(Animation.anims[requestAnim].frameIDs[0])
                                                        .length() - 4),
                                16)].length == 0) {
                        ...
                        onDemandFetcher.requestFileData(1,
                                Integer.parseInt(
                                        Integer.toHexString(SpotAnimDefinition.cache[npc.anInt1520].animation.frameIDs[0])
                                                .substring(0,
                                                        Integer.toHexString(
                                                                        SpotAnimDefinition.cache[npc.anInt1520].animation.frameIDs[0])
                                                                .length() - 4),
                                        16));
                    }
                } catch (Exception e) {
    ...
    private void processRequestedAudio() {
        for (int index = 0; index < currentSound; index++) {
            ...
            try {
                ...
                new SoundPlayer((InputStream) new ByteArrayInputStream(stream.buffer, 0, stream.pos),
                        soundVolume[index], soundDelay[index]);
                if (System.currentTimeMillis() + (long) (stream.pos / 22) > aLong1172
                        + (long) (anInt1257 / 22)) {
    ...
    void startUp() {
        ...
        if (Configuration.REPACK_INDICES) {
            for (int index : Configuration.INDICES_TO_REPACK) {
    ...
    public void load() {
        try {
            ...
            for (int k3 = 0; k3 < 80; k3++) {
                mapScenes[k3] = new IndexedImage(mediaArchives, "mapscene", k3, false);
            }
            ...
            mapBack = new IndexedImage(mediaArchives, "mapback", 0, false);
    ...
    private void appendAnimation(Entity entity) {
         ...
         * animation_1 = SpotAnimDefinition.cache[entity.anInt1520].animation; if
    ...
    private void drawInterface(int scrollOffset, int interfaceX, RSInterface rsInterface, int interfaceY) {
        try {
            ...
            for (int childID = 0; childID < totalChildrens; childID++) {
                ...
                if (child == null || child.hidden || !child.isVisible()) {
                    continue;
                }
                if (child.invisible) {
                    continue;
                ...
                if (child.type == 0) {
                    ...
                    if (rsInterface.drawsAtEnd.contains(child.id) && child.id != 18471 && child.id != 15878) {
                        boolean bumpUp = clientSize == 0 ? (mouseY >= 386) : mouseY >= (clientHeight - 503) + 350;
                            ...
                            for (int width = 0; width < child.width; width++) {
                                ...
                                if (child.inv[spriteIndex] > 0) {
                                    ...
                                    if (itemSpriteX > DrawingArea.topX - 32 && itemSpriteX < DrawingArea.bottomX
                                        ...
                                        //  System.out.println(child.id + " | " + child.invStackSizes[spriteIndex]);
                                        if (child.id == 30375 && child.invStackSizes[spriteIndex] == 1) {
                                            itemOpacity = 90;
                                        }
                                        ...
                                        if (sprite_2 != null) {
                                            if (activeInterfaceType != 0 && anInt1085 == spriteIndex
                                                ...
                                                if (itemOpacity == 256) {
                                                    ...
                                                    sprite_2.drawSpriteWithOpacity(itemSpriteX, itemSpriteY,
                                                            itemOpacity);
                                                }
                                            }
...
/*                                if (child.getShowChangeExclamation() != null && child.getShowChangeExclamation()[index]) {
                            ...
                            if (child.id == 60003) {
                                ...
                                if (maxCapeColors != null) {
                                    ...
                                    if (maxCapeColor != null && maxCapeSlot != -1 && maxCapeSlot != -1) {
                                        GameClient.this.previousMaxCapeColors[maxCapeSlot] = GameClient.this.maxCapeColors[maxCapeSlot];
                                        int hash = JagexColor.toHSB(maxCapeColor.getRed(), maxCapeColor.getGreen(),
                                                maxCapeColor.getBlue());
                                        GameClient.this.maxCapeColors[maxCapeSlot] = hash;
                        ...
                        if (child.centerText)
                            child.getFont()
                                    .drawCenteredString(child.message, childX + child.messageOffsetX, childY + child.messageOffsetY, child.enabledColor, 0);
                        else
                            child.getFont()
                                    .drawBasicString(child.message, childX + 5 + child.messageOffsetX, childY + child.messageOffsetY, child.enabledColor, 0);
                ...
                for (PendingInterfaceModule pendingInterfaceModule : rsInterface.pendingInterfaceModules) {
                    drawInterface(pendingInterfaceModule.getScrollPosition(), pendingInterfaceModule.getChildX(), pendingInterfaceModule.getChild(), pendingInterfaceModule.getChildY());
                }
    ...
    private void readPlayerUpdateMask(int i, int j, Stream stream, Player player) {
        ...
        if ((i & 0x100) != 0) {
            ...
            try {
                if (FrameReader.animationlist[Integer.parseInt(
                        Integer.toHexString(SpotAnimDefinition.cache[player.anInt1520].animation.frameIDs[0])
                                .substring(0,
                                        Integer.toHexString(
                                                        SpotAnimDefinition.cache[player.anInt1520].animation.frameIDs[0])
                                                .length()
                                                - 4),
                        16)].length == 0) {
                    onDemandFetcher.requestFileData(1, Integer.parseInt(
        ...
        if ((i & 0x80) != 0) {
            ...
            stream.pos = currentOffset + chatTextSize;
        }
        if ((i & 1) != 0) {
        ...
        if ((i & 0x20) != 0) {
            ...
            player.constitution = (int) (player.currentHealth = inStream.readByteA());
            player.maxConstitution = (int) (player.maxHealth = inStream.readByteA());
        }
        if ((i & 0x200) != 0) {
    ...
    private void draw3dScreen() {
            ...
            if (clientSize == 0) {
                ...
                if (clientHeight > 565) {
                    ...
                    if (specRequired <= currentSpec)
                        ...
                        color = 0xff0000;
                    smallText.drawCenteredText(color, clientWidth - (31 + 200), currentSpec + "%", clientHeight - (364 - 49), true);
                }
            }
        }
        ...
        if (coinToggle) {
            ...
            if (RSInterface.interfaceCache[8135].message != null) {
                ...
                newRegularFont.drawBasicString("" + StringUtils.numToShort(cash), x, y + 21,
        ...
        if (printMousey != false) {
            System.err.println("Mouse X: " + super.mouseX + " , Mouse Y: " + super.mouseY);
        }
        ...
        if (clientData) {
            ...
            drawingArea.method385(0xffff00, "Terrain, Landscape: " + (regionIndex >= 0 ? (onDemandFetcher.landscapeIds[regionIndex]
                    + ", " + onDemandFetcher.objectMapIds[regionIndex]) : "-1"), 359 - minus, 5);
        ...
        for (RSInterface rsi : RSInterface.interfaceCache) {
            ...
            if (rsi.type == 18 && rsi instanceof DropDownMenu && rsi.id != childId) {
                ...
                if (openInterfaceID == CustomisableHotKeys.interfaceID && ddm.id >= 90040 && ddm.id <= 90054) { // Hot
                    ...
                    RSInterface.interfaceCache[tabStoneSprite].disabledSprite = GameClient.cacheSprite[1037];
                }
            }
        }
    }
    ...
    public void drawTooltip() {
        ...
        if ((this.menuActionRow > 2) && getOption("tooltip_hover")) {
        ...
        if (getOption("tooltip_hover") && (!s.contains("Walk here"))) {
            DrawingArea.drawAlphaPixels(this.mouseX, this.mouseY - 11, newBoldFont.getTextWidth(s.trim()) + 6, 17, 0, 100);
            newBoldFont.drawBasicString(s, this.mouseX + 2, this.mouseY + 2, 16777215, loopCycle / 1000);
        }
        newBoldFont.drawBasicString(s, 4, 15, 16777215, 1);
    }
    ...
    boolean loginButtonHover, usernameHover, passwordHover, rememberHover, registerHover;
    ...
    public void drawLoginScreen() {
        ...
        if (closingClient) {
            ...
            animatedLogin.getInstance(765, 503).drawAdvancedSprite(0, 0);
            SpriteLoader.sprites[loginButtonHover ? 1046 : 1047].drawAdvancedSprite(298, 340);

            if (usernameHover) {
                SpriteLoader.sprites[1039].drawAdvancedSprite(282, 250);
            } else {
                SpriteLoader.sprites[1040].drawAdvancedSprite(282, 250);
            }
            if (passwordHover) {
                SpriteLoader.sprites[1039].drawAdvancedSprite(282, 300);
            } else {
                SpriteLoader.sprites[1040].drawAdvancedSprite(282, 300);
            }
            ...
            SpriteLoader.sprites[rememberHover ? 1041 : 1042].drawAdvancedSprite(444, 334);

            if (rememberActive) {
                SpriteLoader.sprites[1043].drawAdvancedSprite(444, 334);
            }
        }
        if (!isLoading) {
    ...
    private void updatePlayers(int i, Stream stream) {
        ...
        if (stream.pos != i) {
            System.out.println("Error packet size mismatch in getplayer pos:" + stream.pos + " psize:" + i);
            throw new RuntimeException("eek");
        }
...
//			System.out.println("Packet: "+opCode);
            switch (opCode) {
                ...
                case 210:
                    int scrollInterfaceId = inStream.readShort();
                    int scrollMax = inStream.readShort();
                    RSInterface.interfaceCache[scrollInterfaceId].scrollMax = scrollMax;
                    opCode = -1;
                    return true;
                ...
                /*    int flag = inStream.readUnsignedWord();// 1 player, 0 npc
                    ...
                    currentEntityHealth = inStream.readQWord();
                    maximumEntityHealth = inStream.readQWord();
    ...
    private void animateTextures(int id) {
        TextureAnimating.animateTextures(id);
    }
    ...
    public int[] write(int var1, int var2, int var3, int var4, int var5) {
        ...
        if (var1 >= 128 && var3 >= 128 && var1 <= 13056 && var3 <= 13056) {
            ...
            return var3 >= 50 && var3 <= 3500 ? new int[]{Rasterizer.textureInt1 + var1 * WorldController.focalLength / var3,
    ...
    public final String formatDamage(long amount) {
        String format = "Too high!";
    ...
    // Declare a history list to store previously executed commands
    private List<String> commandHistory = new ArrayList<>();
    // Declare a current history index
        ...
        switch (commandStart) {
            ...
            case "p":
                if (commandHistory.size() > 1) {
                    ...
                    commandHistory.remove(commandHistory.size() - 1); // Remove the current command from history
                    sendConsoleMessage("Executing Bash History: " + previousCommand, true); // Display the previous command
                    sendConsoleCommand(previousCommand); // Execute the previous command
                }
                break;
            default:
                stream.createFrame(103);
    ...
    public void setCursor(int id) {
        ...
        if (id == -1 || id == -2 || id == -3) {
            ...
            try {
                ...
                getMainFrame().setCursor(getMainFrame().getToolkit()
    ...
    public String addNewLines(final String text, final int width, final TextDrawingArea tda) {
        int w = 0;
        final StringBuilder sb = new StringBuilder();
        final String[] split;
        final String[] parts = split = text.split(" ");
        for (final String part : split) {
            final int partW = tda.getTextWidth(part);
            if (w + partW > width) {
                w = 0;
                sb.append("\n");
            } else {
    ...
    public static void loadDescriptions() {
        GameClient.itemDescription.load();
    }
    ...
    private Queue<HoverBox> hoverBoxes;
    public List<HoverBox> hoverBoxesAdd;
